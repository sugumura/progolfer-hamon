...
(function(process) {
  ...
  !function() {
    var a,
        ...
        w = {success: !0};
    n && -1 == o.indexOf(f) && (o && (o += " "), o += f, n.className = o), c.indexOf("@") > -1 && (c = "3.5.0"), a = {
      applyConfig: function(a) {
        ...
        var b,
            ...
            i = this.Env._loader;
        for (c in a)
          a.hasOwnProperty(c) && (b = a[c], e && "modules" == c ? v(e, b) : g && "aliases" == c ? v(g, b) : f && "groups" == c ? v(f, b) : "win" == c ? (d[c] = b && b.contentWindow || b, d.doc = d[c] ? d[c].document : null) : "_yuid" != c && (d[c] = b));
        i && i._config(a);
      },
      _config: function(a) {
        this.applyConfig(a);
      ...
      _init: function() {
          ...
          if (d.Env = {
            ...
            parseBasePath: function(a, b) {
              var d,
                  e,
                  c = a.match(b);
              return c && (d = RegExp.leftContext || a.slice(0, a.indexOf(c[0])), e = c[3], c[1] && (d += "?" + c[1]), d = {
                filter: e,
                path: d
              }), d;
            },
            getBase: f && f.getBase || function(b) {
              var f,
                  ...
                  i,
                  j,
                  c = m && m.getElementsByTagName("script") || [],
                  e = h.cdn;
        ...
        d.constructor = YUI, d.config = d.config || {
          bootstrap: !0,
          cacheUse: !0,
          debug: !0,
          doc: m,
      ...
      _setup: function() {
        var a,
            ...
            c = [],
            d = YUI.Env.mods,
            e = b.config.core || [].concat(YUI.Env.core);
      ...
      applyTo: function(a, b, c) {
        if (b in j) {
          var e,
              ...
              d = p[a];
          if (d) {
            for (e = b.split("."), f = d, g = 0; g < e.length; g += 1)
              f = f[e[g]], f || this.log("applyTo not found: " + b, "warn", "yui");
      ...
      add: function(a, b, c, d) {
        ...
        for (j in p)
          p.hasOwnProperty(j) && (i = p[j], g[i.id] || (g[i.id] = !0, h = i.Env._loader, h && (!h.moduleInfo[a] || h.moduleInfo[a].temp) && h.addModule(d, a)));
        return this;
      },
      _attach: function(a, b) {
        var c,
            ...
            k = YUI.Env.aliases,
            l = this,
            n = YUI.Env._renderedMods,
            o = l.Env._loader,
            p = l.Env._attached,
            q = a.length,
            t = [];
        for (c = 0; q > c; c++)
          if (d = a[c], e = j[d], t.push(d), o && o.conditions[d])
            for (m in o.conditions[d])
              o.conditions[d].hasOwnProperty(m) && (r = o.conditions[d][m], s = r && (r.ua && l.UA[r.ua] || r.test && r.test(l)), s && t.push(r.name));
        for (a = t, q = a.length, c = 0; q > c; c++)
          if (!p[a[c]]) {
            ...
            if (e) {
              for (p[d] = !0, m = 0; m < l.Env._missed.length; m++)
                l.Env._missed[m] === d && (l.message("Found: " + d + " (was reported as missing earlier)", "warn", "yui"), l.Env._missed.splice(m, 1));
              if (o && n && n[d] && n[d].temp) {
                o.getRequires(n[d]), g = [];
                for (m in o.moduleInfo[d].expanded_map)
                  o.moduleInfo[d].expanded_map.hasOwnProperty(m) && g.push(m);
                l._attach(g);
              }
      ...
      use: function() {
        ...
        if (c.Lang.isFunction(b) ? (a.pop(), c.config.delayUntil && (b = c._delayCallback(b, c.config.delayUntil))) : b = null, c.Lang.isArray(a[0]) && (a = a[0]), c.config.cacheUse) {
          ...
          if (g)
            return a.length, c._notify(b, w, a), c;
        }
      ...
      _notify: function(a, b, c) {
        if (!b.success && this.config.loadErrorFn)
          ...
          if (this.Env._missed && this.Env._missed.length && (b.msg = "Missing modules: " + this.Env._missed.join(), b.success = !1), this.config.throwFail)
            a(this, b);
          else
            try {
              a(this, b);
      ...
      _use: function(a, b) {
        ...
        var d,
            ...
            x = function(a, b) {
              ...
              if (a.length) {
                if (l) {
                  for (g = a.length, d = 0; g > d; d++)
                    l[a[d]] && !i[a[d]] ? e = [].concat(e, l[a[d]]) : e.push(a[d]);
                  a = e;
                }
                for (g = a.length, d = 0; g > d; d++)
                  f = a[d], b || t.push(f), k[f] || (j = i[f], m = null, n = null, j ? (k[f] = !0, m = j.details.requires, n = j.details.use) : h._loaded[c][f] ? k[f] = !0 : r.push(f), m && m.length && x(m), n && n.length && x(n, 1));
              }
            },
            y = function(c) {
              var e,
      ...
      namespace: function() {
        for (var b,
            ...
            a = arguments,
            c = 0; c < a.length; c++)
          if (b = this, g = a[c], g.indexOf(d) > -1)
            for (f = g.split(d), e = "YAHOO" == f[0] ? 1 : 0; e < f.length; e++)
              b[f[e]] = b[f[e]] || {}, b = b[f[e]];
          else
            b[g] = b[g] || {}, b = b[g];
        return b;
      ...
      error: function(a, b, c) {
        var e,
            d = this;
        if (d.config.errorFn && (e = d.config.errorFn.apply(d, arguments)), !e)
          throw b || new Error(a);
      ...
      stamp: function(a, b) {
        ...
        if (!a)
          return a;
        if (c = a.uniqueID && a.nodeType && 9 !== a.nodeType ? a.uniqueID : "string" == typeof a ? a : a._yuid, !c && (c = this.guid(), !b))
          try {
            a._yuid = c;
          } catch (d) {
            c = null;
    ...
    a.Array = c, c.dedupe = function(a) {
      ...
      for (e = 0, f = a.length; f > e; ++e)
        e in a && (c[a[e]] = d > e && e in b ? b[e] : !0);
      return c;
    }, c.indexOf = l._isNative(m.indexOf) ? function(a, b, c) {
      return m.indexOf.call(a, b, c);
    } : function(a, b, c) {
      var d = a.length;
      for (c = +c || 0, c = (c > 0 || -1) * Math.floor(Math.abs(c)), 0 > c && (c += d, 0 > c && (c = 0)); d > c; ++c)
        if (c in a && a[c] === b)
          return c;
      return -1;
    ...
    a.cached = function(a, b, c) {
      ...
      if (!b || !c)
        return b || a;
      if (f) {
        if (2 === f && a.mix(b.prototype, c.prototype, d, e, 0, g), j = 1 === f || 3 === f ? c.prototype : c, o = 1 === f || 4 === f ? b.prototype : b, !j || !o)
          return b;
      } else
        j = c, o = b;
      if (h = d && !g, e)
        for (k = 0, m = e.length; m > k; ++k)
          l = e[k], n.call(j, l) && (i = h ? !1 : l in o, g && i && p(o[l], !0) && p(j[l], !0) ? a.mix(o[l], j[l], d, null, 0, g) : (d || !i) && (o[l] = j[l]));
      else {
        for (l in j)
          n.call(j, l) && (i = h ? !1 : l in o, g && i && p(o[l], !0) && p(j[l], !0) ? a.mix(o[l], j[l], d, null, 0, g) : (d || !i) && (o[l] = j[l]));
    ...
    var q,
        l = a.Lang,
        n = Object.prototype.hasOwnProperty,
        r = a.Object = l._isNative(Object.create) ? function(a) {
        ...
        s = r._forceEnum = ["hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toString", "toLocaleString", "valueOf"],
        t = r._hasEnumBug = !{valueOf: 0}.propertyIsEnumerable("valueOf"),
        u = r._hasProtoEnumBug = function() {}.propertyIsEnumerable("prototype"),
        v = r.owns = function(a, b) {
          return !!a && n.call(a, b);
        };
    r.hasKey = v, r.keys = l._isNative(Object.keys) ? Object.keys : function(a) {
      ...
      var c,
          ...
          e,
          b = [];
      if (u && "function" == typeof a)
        for (d in a)
          v(a, d) && "prototype" !== d && b.push(d);
      else
        for (d in a)
          v(a, d) && b.push(d);
      if (t)
        for (c = 0, e = s.length; e > c; ++c)
          d = s[c], v(a, d) && b.push(d);
      return b;
    }, r.values = function(a) {
      for (var b = r.keys(a),
          c = 0,
      ...
      var f;
      for (f in b)
        (e || v(b, f)) && c.call(d || a, b[f], f, b);
      return a;
    }, r.some = function(b, c, d, e) {
      var f;
      for (f in b)
        if ((e || v(b, f)) && c.call(d || a, b[f], f, b))
          return !0;
      return !1;
      ...
      for (d = (a + "").split("."), f = (b + "").split("."), g = 0, h = Math.max(d.length, f.length); h > g; ++g) {
        if (c = parseInt(d[g], 10), e = parseInt(f[g], 10), isNaN(c) && (c = 0), isNaN(e) && (e = 0), e > c)
          return -1;
        if (c > e)
          return 1;
      }
    ...
    a.Get = e = {
      ...
      abort: function(a) {
        var b,
            ...
            f;
        if (!a.abort)
          if (c = a, f = this._pending, a = null, f && f.transaction.id === c)
            a = f.transaction, this._pending = null;
          else
            for (b = 0, e = this._queue.length; e > b; ++b)
      ...
      _getEnv: function() {
        var b = a.config.doc,
            c = a.UA;
        return this._env = {
          async: b && b.createElement("script").async === !0 || c.ie >= 10,
      ...
      _getTransaction: function(b, d) {
        ...
        for (c.isArray(b) || (b = [b]), d = a.merge(this.options, d), d.attributes = a.merge(this.options.attributes, d.attributes), g = 0, h = b.length; h > g; ++g) {
          if (j = b[g], i = {attributes: {}}, "string" == typeof j)
            i.url = j;
          else {
            if (!j.url)
              continue;
      ...
      _load: function(a, b, c, d) {
        var f;
        return "function" == typeof c && (d = c, c = {}), c || (c = {}), c.type = a, c._onFinish = e._onTransactionFinish, this._env || this._getEnv(), f = this._getTransaction(b, c), this._queue.push({
          callback: d,
          transaction: f
        }), this._next(), f;
      },
      ...
      _purge: function(b) {
        for (var e,
            ...
            c = this._purgeNodes,
            d = b !== c; f = b.pop(); )
          f._yuiget_finished && (f.parentNode && f.parentNode.removeChild(f), d && (e = a.Array.indexOf(c, f), e > -1 && c.splice(e, 1)));
      }
      ...
      execute: function(a) {
        var e,
            ...
            d = b._state;
        if ("done" === d)
          return a && a(b.errors.length ? b.errors : null, b), void 0;
        if (a && b._callbacks.push(a), "executing" !== d) {
          for (b._state = "executing", b._queue = g = [], b.options.timeout && (b._timeout = setTimeout(function() {
            b.abort("Timeout");
          }, b.options.timeout)), b._reqsWaiting = c.length, e = 0, f = c.length; f > e; ++e)
            h = c[e], h.async || "css" === h.type ? b._insert(h) : g.push(h);
          b._next();
        }
      },
      purge: function() {
      ...
      _createNode: function(a, b, c) {
        var f,
            g,
            e = c.createElement(a);
        d || (g = c.createElement("div"), g.setAttribute("class", "a"), d = "a" === g.className ? {} : {
          "for": "htmlFor",
          "class": "className"
        });
        for (f in b)
          b.hasOwnProperty(f) && e.setAttribute(d[f] || f, b[f]);
        return e;
      },
      _finish: function() {
        var d,
            e,
            f,
            a = this.errors.length ? this.errors : null,
            b = this.options,
            c = b.context || this;
        if ("done" !== this._state) {
          for (this._state = "done", e = 0, f = this._callbacks.length; f > e; ++e)
            this._callbacks[e].call(c, a, this);
      ...
      _poll: function(b) {
        ...
        if (!b || (d || (d = c._pendingCSS = []), d.push(b), !c._pollTimer)) {
          for (c._pollTimer = null, f = 0; f < d.length; ++f)
            if (j = d[f], e) {
              for (k = j.doc.styleSheets, h = k.length, i = j.node.href; --h >= 0; )
                if (k[h].href === i) {
      ...
      _progress: function(a, b) {
        ...
        a && (b.error = a, this.errors.push({
          error: a,
          request: b
        })), b.node._yuiget_finished = b.finished = !0, c.onProgress && c.onProgress.call(c.context || this, this._getEventData(b)), b.autopurge && (e._autoPurge(this.options.purgethreshold), e._purgeNodes.push(b.node)), this._pending === b && (this._pending = null), this._reqsWaiting -= 1, this._next();
      }
    };
    ...
    d("load", "0", {
      ...
      test: function(a) {
        var b = a.config.doc,
            ...
            e = b && b.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1");
      ...
      test: function(a) {
        ...
        var c = a.config.global.JSON,
            ...
            e = a.config.useNativeJSONParse !== !1 && !!d;
        if (e)
          try {
      ...
      test: function(a) {
        var b = a.config.global.JSON,
            ...
            d = a.config.useNativeJSONStringify !== !1 && !!c;
        if (d)
          try {
            d = "0" === c.stringify(0);
          } catch (e) {
    ...
    a.mix(a.namespace("Intl"), {lookupBestLang: function(b, d) {
        ...
        var f,
            ...
            h,
            i;
        for (a.Lang.isString(b) && (b = b.split(c)), f = 0; f < b.length; f += 1)
          if (g = b[f], g && "*" !== g)
            for (; g.length > 0; ) {
              if (h = e(g))
                return h;
              if (i = g.lastIndexOf("-"), !(i >= 0))
                break;
    ...
    c.log = function(a, b, g, h) {
      var i,
          ...
          o = c,
          p = o.config,
          q = o.fire ? o : YUI.Env.globalEvents;
      return p.debug && (g = g || "", "undefined" != typeof g && (j = p.logExclude, k = p.logInclude, !k || g in k ? k && g in k ? i = !k[g] : j && g in j && (i = j[g]) : i = 1, o.config.logLevel = o.config.logLevel || "debug", n = f[o.config.logLevel.toLowerCase()], b in f && f[b] < n && (i = 1)), i || (p.useBrowserConsole && (l = g ? g + ": " + a : a, o.Lang.isFunction(p.logFn) ? p.logFn.call(o, a, b, g) : typeof console !== e && console.log ? (m = b && console[b] && b in f ? b : "log", console[m](l)) : typeof opera !== e && opera.postError(l)), q && !h && (q === o && !q.getEvent(d) && q.publish(d, {broadcast: 2}), q.fire(d, {
        msg: a,
        cat: b,
        src: g
      })))), o;
    ...
    YUI.Env[a.version] || function() {
      ...
      l[b] = {}, l.gallery = {
        ...
        comboBase: j,
        update: m,
        patterns: {"yui2-": {configFn: function(a) {
    ...
    YUI.Env._cssLoaded || (YUI.Env._cssLoaded = {}), a.Env.meta = r, a.Loader = function(b) {
      ...
      _populateCache: function() {
        ...
        if (d && !b.ignoreRegistered) {
          for (e in d)
            d.hasOwnProperty(e) && (b.moduleInfo[e] = a.merge(d[e]));
          d = f._conditions;
          for (e in d)
            d.hasOwnProperty(e) && (b.conditions[e] = a.merge(d[e]));
        } else
          for (e in c)
            c.hasOwnProperty(e) && b.addModule(c[e], e);
      },
      _resetModules: function() {
        var b,
            ...
            f,
            a = this;
        for (b in a.moduleInfo)
          if (a.moduleInfo.hasOwnProperty(b)) {
            if (d = a.moduleInfo[b], e = d.name, f = YUI.Env.mods[e] ? YUI.Env.mods[e].details : null, f && (a.moduleInfo[e]._reset = !0, a.moduleInfo[e].requires = f.requires || [], a.moduleInfo[e].optional = f.optional || [], a.moduleInfo[e].supersedes = f.supercedes || []), d.defaults)
              for (c in d.defaults)
                d.defaults.hasOwnProperty(c) && d[c] && (d[c] = d.defaults[c]);
      ...
      _inspectPage: function() {
        var b,
            ...
            f,
            a = this;
        for (f in a.moduleInfo)
          a.moduleInfo.hasOwnProperty(f) && (b = a.moduleInfo[f], b.type && b.type === h && a.isCSSLoaded(b.name) && (a.loaded[f] = !0));
        for (f in u)
          u.hasOwnProperty(f) && (b = u[f], b.details && (c = a.moduleInfo[b.name], d = b.details.requires, e = c && c.requires, c ? !c._inspected && d && e.length !== d.length && delete c.expanded : c = a.addModule(b.details, f), c._inspected = !0));
      },
      _requires: function(a, b) {
        ...
        if (!i || !j)
          return !1;
        if (d = i.expanded_map, e = i.after_map, e && b in e)
          return !0;
        if (e = j.after_map, e && a in e)
          return !1;
      ...
      _config: function(b) {
          ...
          for (c in b)
            if (b.hasOwnProperty(c))
              if (e = b[c], "require" === c)
                ...
                "string" == typeof e && (j.skin.defaultSkin = b.skin, e = {defaultSkin: e}), a.mix(j.skin, e, !0);
              else if ("groups" === c) {
                for (d in e)
                  if (e.hasOwnProperty(d) && (i = d, h = e[d], j.addGroup(h, i), h.aliases))
                    for (f in h.aliases)
                      h.aliases.hasOwnProperty(f) && j.addAlias(h.aliases[f], f);
              } else if ("modules" === c)
                for (d in e)
                  e.hasOwnProperty(d) && j.addModule(e[d], d);
              else if ("aliases" === c)
                for (d in e)
                  e.hasOwnProperty(d) && j.addAlias(e[d], d);
              else
                "gallery" === c ? this.groups.gallery.update && this.groups.gallery.update(e, b) : "yui2" === c || "2in3" === c ? this.groups.yui2.update && this.groups.yui2.update(b["2in3"], b.yui2, b) : j[c] = e;
        if (g = j.filter, t.isString(g) && (g = g.toUpperCase(), j.filterName = g, j.filter = j.FILTER_DEFS[g], "DEBUG" === g && j.require("yui-log", "dump")), j.filterName && j.coverage && "COVERAGE" === j.filterName && t.isArray(j.coverage) && j.coverage.length) {
          for (c = 0; c < j.coverage.length; c++)
            l = j.coverage[c], j.moduleInfo[l] && j.moduleInfo[l].use ? k = [].concat(k, j.moduleInfo[l].use) : k.push(l);
      ...
      _addSkin: function(a, b, c) {
        var d,
            ...
            i = this.skin,
            j = h[b] && h[b].ext;
        return b && (f = this.formatSkin(a, b), h[f] || (d = h[b], e = d.pkg || b, g = {
          skin: !0,
          name: f,
          group: d.group,
          type: "css",
          ...
          ext: j
        }, d.base && (g.base = d.base), d.configFn && (g.configFn = d.configFn), this.addModule(g, f))), f;
      },
      addAlias: function(a, b) {
        YUI.Env.aliases[b] = a, this.addModule({
          name: b,
          use: a
        });
      },
      addGroup: function(a, b) {
        var e,
            ...
            c = a.modules,
            d = this;
        if (b = b || a.name, a.name = b, d.groups[b] = a, a.patterns)
          for (e in a.patterns)
            a.patterns.hasOwnProperty(e) && (a.patterns[e].group = b, d.patterns[e] = a.patterns[e]);
        if (c)
          for (e in c)
            c.hasOwnProperty(e) && (f = c[e], "string" == typeof f && (f = {
              name: e,
              fullpath: f
            }), f.group = b, d.addModule(f, e));
      },
      addModule: function(b, c) {
        c = c || b.name, "string" == typeof b && (b = {
          name: c,
          fullpath: b
        });
        var d,
            ...
            G,
            F = this.conditions;
        if (this.moduleInfo[c] && this.moduleInfo[c].temp && (b = a.merge(this.moduleInfo[c], b)), b.name = c, !b || !b.name)
          return null;
        if (b.type || (b.type = i, E = b.path || b.fullpath, E && this.REGEX_CSS.test(E) && (b.type = h)), !b.path && !b.fullpath && (b.path = w(c, c, b.type)), b.supersedes = b.supersedes || b.use, b.ext = "ext" in b ? b.ext : this._internal ? !1 : !0, d = b.submodules, this.moduleInfo[c] = b, b.requires = b.requires || [], this.requires)
          for (e = 0; e < this.requires.length; e++)
            b.requires.push(this.requires[e]);
        if (b.group && this.groups && this.groups[b.group] && (D = this.groups[b.group], D.requires))
          for (e = 0; e < D.requires.length; e++)
            b.requires.push(D.requires[e]);
        ...
        }), b.skinnable && b.ext && b.temp && (B = this._addSkin(this.skin.defaultSkin, c), b.requires.unshift(B)), b.requires.length && (b.requires = this.filterRequires(b.requires) || []), !b.langPack && b.lang)
          for (s = p(b.lang), r = 0; r < s.length; r++)
            y = s[r], t = this.getLangPackName(y, c), n = this.moduleInfo[t], n || (n = this._addLangPack(y, b, t));
        if (d) {
          k = b.supersedes || [], g = 0;
          for (e in d)
        ...
        if (o = b.plugins)
          for (e in o)
            o.hasOwnProperty(e) && (q = o[e], q.pkg = c, q.path = q.path || w(c, e, b.type), q.requires = q.requires || [], q.group = b.group, this.addModule(q, e), b.skinnable && this._addSkin(this.skin.defaultSkin, e, c));
        if (b.condition)
          for (j = b.condition.trigger, YUI.Env.aliases[j] && (j = YUI.Env.aliases[j]), a.Lang.isArray(j) || (j = [j]), e = 0; e < j.length; e++)
            G = j[e], C = b.condition.when, F[G] = F[G] || {}, F[G][c] = b.condition, C && "after" !== C ? "instead" === C && (b.supersedes = b.supersedes || [], b.supersedes.push(G)) : (b.after = b.after || [], b.after.push(G));
      ...
      _explodeRollups: function() {
        ...
        if (!a.allowRollup) {
          for (d in i)
            if (i.hasOwnProperty(d) && (b = a.getModule(d), b && b.use))
              for (g = b.use.length, e = 0; g > e; e++)
                if (c = a.getModule(b.use[e]), c && c.use)
                  for (h = c.use.length, f = 0; h > f; f++)
                    i[c.use[f]] = !0;
                else
                  i[b.use[e]] = !0;
          a.required = i;
      ...
      filterRequires: function(b) {
        if (b) {
          ...
          for (d = 0; d < b.length; d++)
            if (e = this.getModule(b[d]), e && e.use)
              for (f = 0; f < e.use.length; f++)
                g = this.getModule(e.use[f]), g && g.use && g.name !== e.name ? c = a.Array.dedupe([].concat(c, this.filterRequires(g.use))) : c.push(e.use[f]);
            else
              c.push(b[d]);
          b = c;
        }
      ...
      getRequires: function(b) {
        ...
        var c,
            ...
            D = b.lang || b.intl,
            E = this.moduleInfo,
            F = a.Features && a.Features.tests.load;
        if (b.temp && r && (x = b, b = this.addModule(r, l), b.group = x.group, b.pkg = x.pkg, delete b.expanded), H = !!this.lang && b.langCache !== this.lang || b.skinCache !== this.skin.defaultSkin, b.expanded && !H)
          return b.expanded;
        for (s = [], G = {}, w = this.filterRequires(b.requires), b.lang && (s.unshift("intl"), w.unshift("intl"), D = !0), y = this.filterRequires(b.optional), b._parsed = !0, b.langCache = this.lang, b.skinCache = this.skin.defaultSkin, c = 0; c < w.length; c++)
          if (!G[w[c]] && (s.push(w[c]), G[w[c]] = !0, e = this.getModule(w[c]), e)) {
            g = this.getRequires(e), D = D || e.expanded_map && j in e.expanded_map;
            for (f = 0; f < g.length; f++)
              s.push(g[f]);
          }
        if (w = this.filterRequires(b.supersedes))
          for (c = 0; c < w.length; c++)
            if (!G[w[c]] && (b.submodules && s.push(w[c]), G[w[c]] = !0, e = this.getModule(w[c]), e)) {
              g = this.getRequires(e), D = D || e.expanded_map && j in e.expanded_map;
              for (f = 0; f < g.length; f++)
                s.push(g[f]);
            }
        if (y && this.loadOptional)
          for (c = 0; c < y.length; c++)
            if (!G[y[c]] && (s.push(y[c]), G[y[c]] = !0, e = E[y[c]], e)) {
              g = this.getRequires(e), D = D || e.expanded_map && j in e.expanded_map;
              for (f = 0; f < g.length; f++)
                s.push(g[f]);
            }
        if (q = this.conditions[l])
          if (b._parsed = !1, k && F)
            o(k, function(a, b) {
              var c = F[b].name;
            ...
            for (c in q)
              if (q.hasOwnProperty(c) && !G[c] && (v = q[c], t = v && (!v.ua && !v.test || v.ua && a.UA[v.ua] || v.test && v.test(a, w)), t && (G[c] = !0, s.push(c), e = this.getModule(c), e)))
                for (g = this.getRequires(e), f = 0; f < g.length; f++)
                  s.push(g[f]);
        if (b.skinnable) {
          A = this.skin.overrides;
          for (c in YUI.Env.aliases)
            YUI.Env.aliases.hasOwnProperty(c) && a.Array.indexOf(YUI.Env.aliases[c], l) > -1 && (B = c);
          if (A && (A[l] || B && A[B]))
            for (C = l, A[B] && (C = B), c = 0; c < A[C].length; c++)
              z = this._addSkin(A[C][c], l), this.isCSSLoaded(z, this._boot) || s.push(z);
          else
            z = this._addSkin(this.skin.defaultSkin, l), this.isCSSLoaded(z, this._boot) || s.push(z);
        }
      ...
      _addLangPack: function(b, c, d) {
        ...
        return h || (f = w(c.pkg || e, d, i, !0), g = {
          ...
          group: c.group,
          supersedes: []
        }, c.root && (g.root = c.root), c.base && (g.base = c.base), c.configFn && (g.configFn = c.configFn), this.addModule(g, d), b && (a.Env.lang = a.Env.lang || {}, a.Env.lang[b] = a.Env.lang[b] || {}, a.Env.lang[b][e] = !0)), this.moduleInfo[d];
      },
      _setup: function() {
        var c,
            d,
            ...
            b = this.moduleInfo;
        for (c in b)
          b.hasOwnProperty(c) && (g = b[c], g && (g.requires = p.dedupe(g.requires), g.lang && (i = this.getLangPackName(m, c), this._addLangPack(null, g, i))));
        h = {}, this.ignoreRegistered || a.mix(h, f.mods), this.ignore && a.mix(h, p.hash(this.ignore));
        for (e in h)
          h.hasOwnProperty(e) && a.mix(h, this.getProvides(e));
        if (this.force)
          for (d = 0; d < this.force.length; d++)
            this.force[d] in h && delete h[this.force[d]];
      ...
      _explode: function() {
        ...
        for (g in b)
          b.hasOwnProperty(g) && (e[g] || (e[g] = !0, c = f.getModule(g), c && (h = c.expound, h && (b[h] = f.getModule(h), d = f.getRequires(b[h]), a.mix(b, p.hash(d))), d = f.getRequires(c), a.mix(b, p.hash(d)))));
      },
      ...
      getModule: function(b) {
        ...
        if (!f || f && f.ext)
          for (e in g)
            if (g.hasOwnProperty(e) && (c = g[e], c.test || (c.test = this._patternTest), c.test(b, e))) {
              d = c;
              break;
            }
      ...
      _reduce: function(a) {
        ...
        var b,
            ...
            e,
            f = this.loadType,
            g = this.ignore ? p.hash(this.ignore) : !1;
        for (b in a)
          if (a.hasOwnProperty(b) && (e = this.getModule(b), ((this.loaded[b] || u[b]) && !this.forceMap[b] && !this.ignoreRegistered || f && e && e.type !== f) && delete a[b], g && g[b] && delete a[b], d = e && e.supersedes, d))
      ...
      _onSuccess: function() {
        var d,
            ...
            c = a.merge(b.skipped),
            e = [],
            f = b.requireRegistration;
        for (j in c)
          c.hasOwnProperty(j) && delete b.inserted[j];
        b.skipped = {};
        for (j in b.inserted)
          b.inserted.hasOwnProperty(j) && (k = b.getModule(j), !k || !f || k.type !== i || j in YUI.Env.mods ? a.mix(b.loaded, b.getProvides(j)) : e.push(j));
        d = b.onSuccess, h = e.length ? "notregistered" : "success", g = !e.length, d && d.call(b.context, {
          msg: h,
          data: b.data,
          success: g,
          failed: e,
      ...
      _onProgress: function(a) {
        ...
        b.onProgress && b.onProgress.call(b.context, {
          name: a.url,
          data: a.data
        });
      },
      _onFailure: function(a) {
        ...
        c = c.join(","), b && b.call(this.context, {
          msg: c,
          data: this.data,
          success: !1
        }), this._finish(c, !1);
      ...
      _sort: function() {
        for (var d,
            ...
            i,
            j,
            a = n.keys(this.required),
            b = {},
            c = 0; ; ) {
          for (d = a.length, i = !1, g = c; d > g; g++) {
            for (e = a[g], h = g + 1; d > h; h++)
              if (j = e + a[h], !b[j] && this._requires(e, a[h])) {
      ...
      _insert: function(b, c, d, e) {
        ...
        return g._refetch = [], d && (f[d === i ? h : i] = []), g.fetchCSS || (f.css = []), f.js.length && j++, f.css.length && j++, n = function(b) {
          ...
          var h,
              ...
              f = "";
          if (b && b.errors)
            for (d = 0; d < b.errors.length; d++)
              f = b.errors[d].request ? b.errors[d].request.url : b.errors[d], c[f] = f;
          if (b && b.data && b.data.length && "success" === b.type)
            for (d = 0; d < b.data.length; d++)
              g.inserted[b.data[d].name] = !0, (b.data[d].lang || b.data[d].skinnable) && (delete g.inserted[b.data[d].name], g._refetch.push(b.data[d].name));
          if (k === j) {
            if (g._loading = null, g._refetch.length) {
              for (d = 0; d < g._refetch.length; d++)
                for (m = g.getRequires(g.getModule(g._refetch[d])), e = 0; e < m.length; e++)
                  g.inserted[m[e]] || (l[m[e]] = m[e]);
              if (l = a.Object.keys(l), l.length) {
                if (g.require(l), n = g.resolve(!0), n.cssMods.length) {
                  for (d = 0; d < n.cssMods.length; d++)
                    i = n.cssMods[d].name, delete YUI.Env._cssLoaded[i], g.isCSSLoaded(i) && (g.inserted[i] = !0, delete g.required[i]);
                  g.sorted = [], g._sort();
                }
                b = null, g._insert();
              }
        ...
        }, this._loading = !0, f.js.length || f.css.length ? (f.css.length && a.Get.css(f.css, {
          data: f.cssMods,
          attributes: g.cssAttributes,
        ...
        }), f.js.length && a.Get.js(f.js, {
          data: f.jsMods,
          insertBefore: g.insertBefore,
          attributes: g.jsAttributes,
          charset: g.charset,
          timeout: g.timeout,
          autopurge: !1,
          context: g,
      ...
      resolve: function(a, b) {
        var d,
            ...
            z = {},
            A = this,
            D = A.ignoreRegistered ? {} : A.inserted,
            E = {
              js: [],
              jsMods: [],
              css: [],
        ...
        for ((A.skin.overrides || A.skin.defaultSkin !== k || A.ignoreRegistered) && A._resetModules(), a && A.calculate(), b = b || A.sorted, G = function(a) {
          a && (l = a.group && A.groups[a.group] || c, l.async === !1 && (a.async = l.async), j = a.fullpath ? A._filter(a.fullpath, b[f]) : A._url(a.path, b[f], l.base || a.base), (a.attributes || a.async === !1) && (j = {
            url: j,
            async: a.async
          }, a.attributes && (j.attributes = a.attributes)), E[a.type].push(j), E[a.type + "Mods"].push(a));
        ...
        for (n in q)
          if (q.hasOwnProperty(n) && (z[n] = z[n] || {
            js: [],
            jsMods: [],
            css: [],
            cssMods: []
          }, j = n, r = q[n], d = r.length, d))
            for (f = 0; d > f; f++)
              D[r[f]] || (g = r[f], !g || !g.combine && g.ext ? r[f] && G(r[f]) : (z[n].comboSep = g.comboSep, z[n].group = g.group, z[n].maxURLLength = g.maxURLLength, o = (t.isValue(g.root) ? g.root : A.root) + (g.path || g.fullpath), o = A._filter(o, g.name), z[n][g.type].push(o), z[n][g.type + "Mods"].push(g)));
        for (n in z)
          if (z.hasOwnProperty(n)) {
            u = n, B = z[u].comboSep || A.comboSep, C = z[u].maxURLLength || A.maxURLLength;
            for (F in z[u])
              if (F === i || F === h) {
                if (v = z[u][F], r = z[u][F + "Mods"], d = v.length, x = u + v.join(B), y = x.length, C <= u.length && (C = e), d)
                  if (y > C) {
                    for (w = [], b = 0; d > b; b++)
                      w.push(v[b]), x = u + w.join(B), x.length > C && (g = w.pop(), x = u + w.join(B), E[F].push(A._filter(x, null, z[u].group)), w = [], g && w.push(g));
                    w.length && (x = u + w.join(B), E[F].push(A._filter(x, null, z[u].group)));
                  } else
                    E[F].push(A._filter(x, null, z[u].group));
    ...
    a.Loader.prototype._rollup = function() {
      ...
      if (this.dirty || !this.rollups) {
        this.rollups = {};
        for (a in g)
          g.hasOwnProperty(a) && (c = this.getModule(a), c && c.rollup && (this.rollups[a] = c));
      }
      for (; ; ) {
        h = !1;
        for (a in this.rollups)
          if (this.rollups.hasOwnProperty(a) && !e[a] && (!this.loaded[a] || this.forceMap[a])) {
            if (c = this.getModule(a), d = c.supersedes || [], f = !1, !c.rollup)
              continue;
            for (i = 0, b = 0; b < d.length; b++) {
              ...
              if (e[d[b]] && c.type === j.type && (i++, f = i >= c.rollup))
                break;
            }
    ...
    YUI.Env[a.version].modules = YUI.Env[a.version].modules || {}, a.mix(YUI.Env[a.version].modules, {
      ...
      datatable: {use: ["datatable-core", "datatable-table", "datatable-head", "datatable-body", "datatable-base", "datatable-column-widths", "datatable-message", "datatable-mutable", "datatable-sort", "datatable-datasource"]},
      "datatable-base": {
      ...
      "graphics-canvas-default": {condition: {
          name: "graphics-canvas-default",
          test: function(a) {
            var b = a.config.doc,
                c = a.config.defaultGraphicEngine && "canvas" == a.config.defaultGraphicEngine,
      ...
      "graphics-svg-default": {condition: {
          name: "graphics-svg-default",
          test: function(a) {
            var b = a.config.doc,
                c = !a.config.defaultGraphicEngine || "canvas" != a.config.defaultGraphicEngine,
      ...
      "graphics-vml-default": {condition: {
          name: "graphics-vml-default",
          test: function(a) {
            var b = a.config.doc,
                c = b && b.createElement("canvas");
      ...
      "node-scroll-info": {requires: ["base-build", "dom-screen", "event-resize", "node-pluginhost", "plugin"]},
    ...
    }), YUI.Env[a.version].md5 = "12bd02dfcbc39e6eebb7a8d96ada727c";
  }, "3.10.1", {requires: ["loader-base"]}), YUI.add("yui", function() {}, "3.10.1", {use: ["yui-base", "get", "features", "intl-base", "yui-log", "yui-later", "loader-base", "loader-rollup", "loader-yui3"]}), YUI().use("yuidoc-meta", "api-list", "history-hash", "node-screen", "node-style", "pjax", function(a) {
    var e,
        f,
        g,
        h,
    ...
    a.getLocation().protocol.match(/^https?\:/) || (a.Router.html5 = !1), f = a.Pjax.defaultRoute.concat(function(a, b, c) {
      ...
      routes: [{
        ...
        callbacks: [f, "handleClasses"]
      }, {
        path: "/files/*file",
        callbacks: [f, "handleFiles"]
      }, {
      ...
      a.all("#classdocs .api-class-tab").size() && (g && (g.destroy(), h = null), g = new a.TabView({
        srcNode: "#classdocs",
        on: {selectionChange: e.onTabSelectionChange}
      }), e.updateTabState(), g.render());
      ...
      var d,
          f,
          g,
          a = /^(?:classes|files|modules)$/,
          b = e._getPathRoot().split("/"),
          c = [];
      ...
      var g,
          c = a.hash,
          f = a.originEvent && a.originEvent.target;
      ...
      var b = a.newVal,
          d = b.get("contentBox").getAttribute("href").substring(1);
    ...
    a.APISearch = a.Base.create("apiSearch", a.Base, [a.AutoCompleteBase], {
      RESULT_TEMPLATE: '<li class="result {resultType}"><a href="{url}"><h3 class="title">{name}</h3><span class="type">{resultType}</span><div class="description">{description}</div><span class="className">{class}</span></a></li>',
      ...
      _apiTextLocator: function(a) {
        ...
        resultFormatter: {valueFn: function() {
        ...
        resultListLocator: {value: "data.results"},
        resultTextLocator: {valueFn: function() {
    ...
    function p(e) {
      var f = a.one(a.config.doc.createDocumentFragment()),
          g = o(),
          h = j.get("queryType"),
          i = "classes" === h ? "class" : "module";
      e.results.length ? c.each(e.results, function(a) {
        f.append(b.sub(n, {
          rootPath: d.rootPath,
          displayName: j.getDisplayName(a.highlighted),
          name: a.text,
          typePlural: h,
          typeSingular: i
        }));
      ...
      switch (i.selected = {
        ...
        case "modules":
          j.setAttrs({
            minQueryLength: 0,
            queryType: c
          }), k.set("minQueryLength", -1), a.prevVal && j.sendRequest(j.get("value"));
          break;
        case "everything":
    ...
    function u(b) {
      ...
      if (b.ctrlKey || b.metaKey)
        switch (b.preventDefault(), b.keyCode) {
          case 37:
    ...
    var b = a.Lang,
        c = a.Array,
        d = a.namespace("APIList"),
        e = a.one("#api-classes"),
        f = a.one("#api-filter"),
        g = a.one("#api-modules"),
        h = a.one("#api-tabview"),
        i = d.tabs = {},
        j = d.filter = new a.APIFilter({
          inputNode: f,
          maxResults: 1e3,
          on: {results: p}
        }),
        k = d.search = new a.APISearch({
          inputNode: f,
          maxResults: 100,
          on: {
            clear: q,
        ...
        l = d.tabview = new a.TabView({
          srcNode: h,
          panelNode: "#api-tabview-panel",
          render: !0,
          on: {selectionChange: t}
        }),
        m = d.focusManager = h.plug(a.Plugin.NodeFocusManager, {
          circular: !0,
        ...
        n = '<li class="api-list-item {typeSingular}"><a href="{rootPath}{typePlural}/{name}.html">{displayName}</a></li>';
    a.before(function(b) {
    ...
    a.APIFilter = a.Base.create("apiFilter", a.Base, [a.AutoCompleteBase], {
      ...
      getDisplayName: function(b) {
        ...
        resultHighlighter: {value: "phraseMatch"},
        queryType: {value: "classes"},
        source: {valueFn: function() {
            var b = this;
            return function(c) {
              var d = a.YUIDoc.meta[b.get("queryType")],
                  e = [];
  ...
  !function() {
    function D(a) {
      ...
      function k(a) {
        var b = a.substring(1, a.length - 1).match(new RegExp("\\\\u[0-9A-Fa-f]{4}|\\\\x[0-9A-Fa-f]{2}|\\\\[0-3][0-7]{0,2}|\\\\[0-7]{1,2}|\\\\[\\s\\S]|-|[^-\\\\]", "g")),
            c = [],
            d = "^" === b[0],
            e = ["["];
        d && e.push("^");
      ...
      function l(a) {
        for (var d = a.source.match(new RegExp("(?:\\[(?:[^\\x5C\\x5D]|\\\\[\\s\\S])*\\]|\\\\u[A-Fa-f0-9]{4}|\\\\x[A-Fa-f0-9]{2}|\\\\[0-9]+|\\\\[^ux0-9]|\\(\\?[:!=]|[\\(\\)\\^]|[^\\x5B\\x5C\\(\\)\\^]+)", "g")),
            e = d.length,
            f = [],
            g = 0,
            h = 0; e > g; ++g) {
    ...
    function L(a, b, c) {
      ...
      function j(a) {
        ...
        for (; !a.nextSibling; )
          if (a = a.parentNode, !a)
            return;
        for (var d,
            c = b(a.nextSibling, 0); (d = c.parentNode) && 1 === d.nodeType; )
          c = d;
        h.push(c);
      }
      for (var d = /(?:^|\s)nocode(?:\s|$)/,
          e = /\r\n?|\n/,
          f = a.ownerDocument,
          g = f.createElement("li"); a.firstChild; )
      ...
      for (var m = Math.max(0, 0 | b - 1) || 0,
          k = 0,
          n = h.length; n > k; ++k)
        g = h[k], g.className = "L" + (k + m) % 10, g.firstChild || g.appendChild(f.createTextNode("\xa0")), l.appendChild(g);
      a.appendChild(l);
    }
    function M(a) {
      ...
      function r() {
        for (var c = a.PR_SHOULD_USE_CONTINUATION ? i.now() + 250 : 1 / 0; j < e.length && i.now() < c; j++) {
          ...
          if (m.test(f) && !n.test(f)) {
            for (var g = !1,
                h = d.parentNode; h; h = h.parentNode) {
              var s = h.tagName;
            ...
            if (!g) {
              ...
              if (o.test(d.tagName))
                ...
                var w = d.currentStyle,
                    x = w ? w.whiteSpace : document.defaultView && document.defaultView.getComputedStyle ? document.defaultView.getComputedStyle(d, null).getPropertyValue("white-space") : 0;
                v = x && "pre" === x.substring(0, 3);
              }
              var y = d.className.match(/\blinenums\b(?::(\d+))?/);
              y = y ? y[1] && y[1].length ? +y[1] : !0 : !1, y && L(d, y, v), k = {
                langExtension: t,
                sourceNode: d,
                numberLines: y,
                pre: v
    ...
    var a = window,
        ...
        c = [b, "auto,case,char,const,default,double,enum,extern,float,goto,int,long,register,short,signed,sizeof,static,struct,switch,typedef,union,unsigned,void,volatile"],
        d = [c, "catch,class,delete,false,import,new,operator,private,protected,public,this,throw,true,try,typeof"],
        e = [d, "alignof,align_union,asm,axiom,bool,concept,concept_map,const_cast,constexpr,decltype,dynamic_cast,explicit,export,friend,inline,late_check,mutable,namespace,nullptr,reinterpret_cast,static_assert,static_cast,template,typeid,typename,using,virtual,where"],
        ...
        g = [f, "as,base,by,checked,decimal,delegate,descending,dynamic,event,fixed,foreach,from,group,implicit,in,interface,internal,into,is,let,lock,object,out,override,orderby,params,partial,readonly,ref,sbyte,sealed,stackalloc,string,select,uint,ulong,unchecked,unsafe,ushort,var,virtual,where"],
        h = "all,and,by,catch,class,else,extends,false,finally,for,if,in,is,isnt,loop,new,no,not,null,of,off,on,or,return,super,then,throw,true,try,unless,until,when,while,yes",
        i = [d, "debugger,eval,export,function,get,null,set,undefined,var,with,Infinity,NaN"],
        j = "caller,delete,die,do,dump,elsif,eval,exit,foreach,for,goto,if,import,last,local,my,next,no,our,print,package,redo,require,sub,undef,unless,until,use,wantarray,while,BEGIN,END",
        k = [b, "and,as,assert,class,def,del,elif,except,exec,finally,from,global,import,in,is,lambda,nonlocal,not,or,pass,print,raise,try,with,yield,False,True,None"],
        l = [b, "alias,and,begin,case,class,def,defined,elsif,end,ensure,false,in,module,next,nil,not,or,redo,rescue,retry,self,super,then,true,undef,unless,until,when,yield,BEGIN,END"],
        m = [b, "case,done,elif,esac,eval,fi,function,in,local,set,then,until"],
        n = [e, g, i, j + k, l, m],
        o = /^(DIR|FILE|vector|(de|priority_)?queue|list|stack|(const_)?iterator|(multi)?(set|map)|bitset|u?(int|float)\d*)\b/,
        p = "str",
        q = "kwd",
        r = "com",
        s = "typ",
        ...
        A = "atv",
        B = "nocode",
        C = "(?:^^\\.?|[+-]|[!=]=?=?|\\#|%=?|&&?=?|\\(|\\*=?|[+\\-]=|->|\\/=?|::?|<<?=?|>>?>?=?|,|;|\\?|@|\\[|~|{|\\^\\^?=?|\\|\\|?=?|break|case|continue|delete|do|else|finally|instanceof|return|throw|try|typeof)\\s*",
        G = /\S/,
        K = J({
          keywords: n,
          hashComments: !0,
        ...
        N = {};
    O(K, ["default-code"]), O(I([], [[v, /^[^<?]+/], [x, /^<!\w[^>]*(?:>|$)/], [r, /^<\!--[\s\S]*?(?:-\->|$)/], ["lang-", /^<\?([\s\S]+?)(?:\?>|$)/], ["lang-", /^<%([\s\S]+?)(?:%>|$)/], [u, /^(?:<[%?]|[%?]>)/], ["lang-", /^<xmp\b[^>]*>([\s\S]+?)<\/xmp\b[^>]*>/i], ["lang-js", /^<script\b[^>]*>([\s\S]*?)(<\/script\b[^>]*>)/i], ["lang-css", /^<style\b[^>]*>([\s\S]*?)(<\/style\b[^>]*>)/i], ["lang-in.tag", /^(<\/?[a-z][^<>]*>)/i]]), ["default-markup", "htm", "html", "mxml", "xhtml", "xml", "xsl"]), O(I([[v, /^[\s]+/, null, " 	\r\n"], [A, /^(?:\"[^\"]*\"?|\'[^\']*\'?)/, null, "\"'"]], [[w, /^^<\/?[a-z](?:[\w.:-]*\w)?|\/?>$/i], [z, /^(?!style[\s=]|on)[a-z](?:[\w:-]*\w)?/i], ["lang-uq.val", /^=\s*([^>\'\"\s]*(?:[^>\'\"\s\/]|\/(?=\s)))/], [u, /^[=<>\/]+/], ["lang-js", /^on\w+\s*=\s*\"([^\"]+)\"/i], ["lang-js", /^on\w+\s*=\s*\'([^\']+)\'/i], ["lang-js", /^on\w+\s*=\s*([^\"\'>\s]+)/i], ["lang-css", /^style\s*=\s*\"([^\"]+)\"/i], ["lang-css", /^style\s*=\s*\'([^\']+)\'/i], ["lang-css", /^style\s*=\s*([^\"\'>\s]+)/i]]), ["in.tag"]), O(I([], [[A, /^[\s\S]+/]]), ["uq.val"]), O(J({
      keywords: e,
      hashComments: !0,
      cStyleComments: !0,
      types: o
    }), ["c", "cc", "cpp", "cxx", "cyc", "m"]), O(J({keywords: "null,true,false"}), ["json"]), O(J({
      keywords: g,
      hashComments: !0,
      cStyleComments: !0,
      verbatimStrings: !0,
    ...
    a.augment = function(b, c, d, e, f) {
      ...
      var j,
          k,
          l;
      if (!d.isObject(b) || a.instanceOf(b, YUI) || b.addEventListener || b.attachEvent)
        return b;
      switch (k = i || {}, d.type(b)) {
        case "date":
          return new Date(b);
      ...
      return function() {
        var f = d.isString(b) ? c[b] : b,
            g = e ? e.concat(a.Array(arguments, 0, !0)) : arguments;
      ...
      return function() {
        var f = d.isString(b) ? c[b] : b,
            g = e ? a.Array(arguments, 0, !0).concat(e) : arguments;
        return f.apply(c || f, g);
      };
    };
    ...
    a.Do = e, e.Method = function(a, b) {
      ...
      var c,
          d,
          f,
          b = a.Array(arguments, 0, !0),
          g = this.before,
          h = this.after,
          i = !1;
      for (c in g)
        if (g.hasOwnProperty(c) && (d = g[c].apply(this.obj, b)))
      ...
      for (c in h)
        if (h.hasOwnProperty(c)) {
          if (f = h[c].apply(this.obj, b), f && f.constructor === e.Halt)
            return f.retVal;
    ...
    var f = a.Array,
        g = "after",
        h = ["broadcast", "monitored", "bubbles", "context", "contextFn", "currentTarget", "defaultFn", "defaultTargetOnly", "details", "emitFacade", "fireOnce", "async", "host", "preventable", "preventedFn", "queuable", "silent", "stoppedFn", "target", "type"],
        i = f.hash(h),
    ...
    a.CustomEvent = function(b, c) {
    ...
    }, a.CustomEvent.keepDeprecatedSubs = !1, a.CustomEvent.mixConfigs = m, a.CustomEvent.prototype = {
      ...
      detach: function(a) {
        ...
        var c,
            ...
            g = this._afters;
        if (f)
          for (c = f.length; c >= 0; c--)
            d = f[c], d && (!a || a === d.fn) && (this._delete(d, f, c), e++);
        if (g)
          for (c = g.length; c >= 0; c--)
            d = g[c], d && (!a || a === d.fn) && (this._delete(d, g, c), e++);
        return e;
      },
      ...
      _procSubs: function(a, b, c) {
        var d,
            ...
            f;
        for (e = 0, f = a.length; f > e; e++)
          if (d = a[e], d && d.fn && (!1 === this._notify(d, b, c) && (this.stopped = 2), 2 === this.stopped))
            return !1;
        return !0;
      },
      ...
      _delete: function(a, b, c) {
        var d = a._when;
        b || (b = d === g ? this._afters : this._subscribers, c = f.indexOf(b, a, 0)), b && a && b[c] === a && (b.splice(c, 1), 0 === b.length && (d === g ? this._hasAfters = !1 : this._hasSubs = !1)), this._kds && (d === g ? delete this.afters[a.id] : delete this.subscribers[a.id]), this.monitored && this.host && this.host._monitor("detach", this, {
          ce: this,
          sub: a
        }), a && (a.deleted = !0);
      }
      ...
      notify: function(b, c) {
        var d = this.context,
            e = !0;
        if (d || (d = c.contextFn ? c.contextFn() : c.context), a.config && a.config.throwFail)
    ...
    var n = a.Lang,
        ...
        v = function(b) {
          ...
          }), d = c.config, b && (m(d, b, !0), void 0 !== b.chain && (c.chain = b.chain), b.prefix && (d.prefix = b.prefix));
        };
    v.prototype = {
      constructor: v,
      once: function() {
      ...
      on: function(b, c, d) {
        var g,
            ...
            y,
            e = this._yuievt,
            f = u(b, e.config.prefix),
            p = a.Env.evt.handles,
            v = a.Node;
        return this._monitor("attach", f[1], {
          args: arguments,
          category: f[0],
          after: f[2]
        }), n.isObject(b) ? n.isFunction(b) ? a.Do.before.apply(a.Do, arguments) : (g = c, h = d, i = j.call(arguments, 0), k = [], n.isArray(b) && (y = !0), r = b._after, delete b._after, a.each(b, function(a, b) {
      ...
      detach: function(b, c, d) {
        var f,
            ...
            g = a.Node,
            h = g && a.instanceOf(this, g);
        if (!b && this !== a) {
          for (f in e)
            e.hasOwnProperty(f) && e[f].detach(c, d);
        ...
        var m,
            ...
            r,
            s,
            i = u(b, this._yuievt.config.prefix),
            k = n.isArray(i) ? i[0] : null,
            l = i ? i[3] : null,
            o = a.Env.evt.handles,
            t = function(a, b, c) {
              var e,
              ...
              if (d)
                for (f = d.length - 1; f >= 0; --f)
                  e = d[f].evt, (e.host === c || e.el === c) && d[f].detach();
            };
        if (k) {
          if (q = o[k], b = i[1], p = h ? a.Node.getDOMNode(this) : this, q) {
            if (b)
              ...
              for (f in q)
                q.hasOwnProperty(f) && t(q, f, p);
            return this;
          }
        } else {
          if (n.isObject(b) && b.detach)
            return b.detach(), this;
          if (h && (!l || l in g.DOM_EVENTS))
            return r = j.call(arguments, 0), r[2] = g.getDOMNode(this), a.detach.apply(a, r), this;
        }
        if (m = a.Env.evt.plugins[l], a.instanceOf(this, YUI)) {
          if (r = j.call(arguments, 0), m && m.detach)
            return m.detach.apply(a, r), this;
          if (!b || !m && g && b in g.DOM_EVENTS)
            return r[0] = b, a.Event.detach.apply(a.Event, r), this;
        }
      ...
      fire: function(a) {
        var h,
            ...
            f = e.config,
            g = f.prefix;
        if (l = b && 2 >= c ? 2 === c ? [arguments[1]] : [] : j.call(arguments, b ? 1 : 0), b || (d = a && a.type), g && (d = t(d, g)), i = e.events[d], this._hasSiblings && (k = this.getSibling(d, i), k && !i && (i = this.publish(d))), (f.monitored && (!i || i.monitored) || i && i.monitored) && this._monitor("fire", i || d, {args: l}), i)
          k && (i.sibling = k), h = i._fire(l);
        else {
          if (e.hasTargets)
            return this.bubble({type: d}, l, this);
          h = !0;
        }
    ...
    var c = "nodeType",
        ...
        p = {
          ...
          ancestors: function(a, b, c, d) {
            for (var e = a,
                f = []; e = p.ancestor(e, b, c, d); )
              if (c = !1, e && (f.unshift(e), d && d(e)))
                return f;
            return f;
          },
          ...
          allById: function(b, c) {
            ...
            if (c.querySelectorAll)
              e = c.querySelectorAll('[id="' + b + '"]');
            else if (c.all) {
              if (d = c.all(b), d && (d.nodeName && (d.id === b ? (e.push(d), d = n) : d = [d]), d.length))
                for (f = 0; g = d[f++]; )
                  (g.id === b || g.attributes && g.attributes.id && g.attributes.id.value === b) && e.push(g);
            } else
              e = [p._getDoc(c).getElementById(b)];
            return e;
          },
          isWindow: function(a) {
          ...
          _batch: function(a, b, c, d, e, f) {
            ...
            if (b && a)
              for (; i = a[h++]; )
                g = g = b.call(p, i, c, d, e, f), "undefined" != typeof g && (j || (j = []), j.push(g));
    ...
    a.mix(d, {
      ...
      creators: {}
    }), h("value-set", "select", {test: function() {
      ...
      for (var f,
          c = 0,
          e = a.getElementsByTagName("option"); f = e[c++]; )
        if (d.getValue(f) === b) {
          f.selected = !0;
          break;
        }
    ...
    a.mix(a.DOM, {
      ...
      _children: function(a, b) {
        var e,
            ...
            c = 0,
            d = a.children;
        if (d && d.tags && (b ? d = a.children.tags(b) : f = d.tags("!").length), !d || !d.tags && b || f)
          for (e = d || a.childNodes, d = []; g = e[c++]; )
            1 === g.nodeType && (!b || b === g.tagName) && d.push(g);
        return d || [];
      },
      create: function(b, c) {
      ...
      _nl2frag: function(b, c) {
        ...
        if (b && (b.push || b.item) && b[0])
          for (c = c || b[0].ownerDocument, d = c.createDocumentFragment(), b.item && (b = a.Array(b, 0, !0)), e = 0, f = b.length; f > e; e++)
            d.appendChild(b[e]);
        return d;
      },
      addHTML: function(b, c, e) {
        ...
        if (void 0 != c)
          if (c.nodeType)
            ...
            i = j = d.create(c);
          else if (c[0] && c[0].nodeType)
            for (j = a.config.doc.createDocumentFragment(); h = c[g++]; )
              j.appendChild(h);
        if (e)
          if (j && e.parentNode)
      ...
      unwrap: function(a) {
        ...
        if (b)
          if (e = b.parentNode) {
            for (a = b.firstChild; a !== c; )
              d = a.nextSibling, e.insertBefore(a, b), a = d;
            e.replaceChild(c, b);
          } else
            b.removeChild(a);
      }
      ...
      var e = d.create(q + b + r, c),
          f = a.DOM._children(e, "tbody")[0];
    ...
    }, n.link = n.style = n.script), i("innerhtml-div", "tr") || (a.mix(n, {
      option: function(a, b) {
          ...
          d = {
            ...
            _deDupe: function(a) {
              var c,
                  ...
                  b = [];
              for (c = 0; d = a[c++]; )
                d._found || (b[b.length] = d, d._found = !0);
              for (c = 0; d = b[c++]; )
                d._found = null, d.removeAttribute("_found");
              return b;
            },
            query: function(b, c, e, f) {
              ...
              var j,
                  ...
                  l,
                  g = [],
                  h = a.Selector.useNative && a.config.doc.querySelector && !f,
                  i = [[b, c]],
                  m = h ? a.Selector._nativeQuery : a.Selector._bruteQuery;
              if (b && m) {
                for (!f && (!h || c.tagName) && (i = d._splitQueries(b, c)), l = 0; j = i[l++]; )
                  k = m(j[0], j[1], e), e || (k = a.Array(k, 0, !0)), k && (g = g.concat(k));
            ...
            _replaceSelector: function(b) {
              var e,
                  f,
                  c = a.Selector._parse("esc", b);
              return b = a.Selector._replace("esc", b), f = a.Selector._parse("pseudo", b), b = d._replace("pseudo", b), e = a.Selector._parse("attr", b), b = a.Selector._replace("attr", b), {
                esc: c,
                attrs: e,
                pseudos: f,
                selector: b
            ...
            _splitQueries: function(b, c) {
              ...
              var g,
                  ...
                  f = "";
              if (c)
                for (1 === c.nodeType && (g = a.Selector._escapeId(a.DOM.getId(c)), g || (g = a.guid(), a.DOM.setId(c, g)), f = '[id="' + g + '"] '), h = 0, i = d.length; i > h; ++h)
                  b = f + d[h], e.push([b, c]);
              return e;
            },
            _nativeQuery: function(b, c, d) {
              if (a.UA.webkit && b.indexOf(":checked") > -1 && a.Selector.pseudos && a.Selector.pseudos.checked)
            ...
            filter: function(b, c) {
              ...
              if (b && c)
                for (e = 0; f = b[e++]; )
                  a.Selector.test(f, c) && (d[d.length] = f);
              return d;
            },
            test: function(b, d, e) {
              var h,
              ...
              if (b && b.tagName)
                if ("function" == typeof d)
                  ...
                  for (h = d.split(","), !e && !a.DOM.inDoc(b) && (i = b.parentNode, i ? e = i : (l = b[c].createDocumentFragment(), l.appendChild(b), e = l, g = !0)), e = e || b[c], m = a.Selector._escapeId(a.DOM.getId(b)), m || (m = a.guid(), a.DOM.setId(b, m)), n = 0; p = h[n++]; ) {
                    for (p += '[id="' + m + '"]', k = a.Selector.query(p, e), o = 0; j = k[o++]; )
                      if (j === b) {
                        f = !0;
                        break;
                      }
  ...
  }, "3.10.1", {requires: ["dom-base"]}), YUI.add("selector", function() {}, "3.10.1", {requires: ["selector-native"]}), YUI.add("node-core", function(a) {
    var c = ".",
        d = "nodeName",
        e = "nodeType",
        f = "ownerDocument",
        ...
        l = function(b) {
          if (!this.getDOMNode)
            return new l(b);
          if ("string" == typeof b && (b = l._fromString(b), !b))
            return null;
    ...
    l.ATTRS = {}, l.DOM_EVENTS = {}, l._fromString = function(b) {
      ...
      if (b) {
        if ("string" == typeof b) {
          if (b = l._fromString(b), !b)
            return null;
        } else if (b.getDOMNode)
          return b;
      ...
      destroy: function(b) {
        var d,
            c = a.config.doc.uniqueID ? "uniqueID" : "_yuid";
    ...
    n.NAME = "NodeList", n.getDOMNodes = function(a) {
      ...
      b && c && (n.prototype[b] = function() {
        ...
        return a.Array.each(this._nodes, function(f) {
          var i,
              j,
              g = f.uniqueID && 9 !== f.nodeType ? "uniqueID" : "_yuid",
              h = a.Node._instances[f[g]];
      ...
      toString: function() {
        var e,
            a = "",
            b = this[h] + ": not bound to any nodes",
            c = this._nodes;
    ...
    a.Object.each(q, function(b, c) {
      o.prototype[c] = function() {
        for (var f,
            g,
            d = [],
            e = 0; "undefined" != typeof(f = arguments[e++]); )
          d.push(f._node || f._nodes || f);
    ...
    d.ATTRS = {
      ...
      children: {getter: function() {
          var d,
              ...
              c = b.children;
          if (!c)
            for (d = b.childNodes, c = [], e = 0, f = d.length; f > e; ++e)
              d[e].tagName && (c[c.length] = d[e]);
          return a.all(c);
        }},
      value: {
        getter: function() {
    ...
    d.DOM_EVENTS = {
      ...
      textInput: 1,
      unload: 1
    }, a.mix(d.DOM_EVENTS, a.Env.evt.plugins), a.augment(d, a.EventTarget), a.mix(d.prototype, {purge: function(b, c) {
        return a.Event.purgeElement(this._node, b, c), this;
      }}), a.mix(a.NodeList.prototype, {
      _prepEvtArgs: function(b, c, d) {
    ...
    }), f.importMethod(a.Node.prototype, ["detach", "detachAll"]), a.mix(a.Node.ATTRS, {
      offsetHeight: {
        setter: function(b) {
      ...
      offsetWidth: {
        ...
        var d;
        arguments.length < 2 && (d = a.one(b), b = d.get("offsetWidth"), c = d.get("offsetHeight")), this.setAttrs({
          offsetWidth: b,
          offsetHeight: c
        });
      }});
    ...
    a.mix(d.prototype, {
      ...
      _bypassProxy: !0
    }, a.config.doc.createElement("form").elements.nodeType && (a.Node.ATTRS.elements = {getter: function() {
      ...
      _getDataAttributes: function(a) {
        ...
        for (var g,
            b = 0,
            c = this._node.attributes,
            d = c.length,
            e = this.DATA_PREFIX,
            f = e.length; d > b; )
          g = c[b].name, 0 === g.indexOf(e) && (g = g.substr(f), g in a || (a[g] = this._getDataAttribute(g))), b += 1;
        return a;
      },
    ...
    a.extend(g, Object, {
      ...
      var b = a.DOM,
          ...
          m = a.CustomEvent.prototype._delete,
          n = function() {
            ...
            return {
              ...
              onAvailable: function(b, c, d, e, f, g) {
                ...
                return h = this.POLL_RETRYS, setTimeout(o._poll, 0), k = new a.EventHandle({_delete: function() {
                    if (k.handle)
                      return k.handle.detach(), void 0;
                    var a,
                        b;
                    for (a = 0; a < i.length; a++)
                      for (b = 0; b < m.length; b++)
                        i[a] === m[b].id && m.splice(b, 1);
                  }});
              },
              ...
              _createWrapper: function(b, c, d, g, h) {
                var i,
                    j = a.stamp(b),
                    k = "event:" + j + c;
                return !1 === h && (k += "native"), d && (k += "capture"), i = p[k], i || (i = a.publish(k, {
                  silent: !0,
                  bubbles: !1,
                  contextFn: function() {
              ...
              _attach: function(c, d) {
                var f,
                    ...
                    t = d && d.capture,
                    u = d && d.overrides;
                if (c[c.length - 1] === k && (f = !0), !q || !q.call)
                  return !1;
                if (l(r))
                  return g = [], a.each(r, function(a) {
                ...
                if (a.Lang.isString(r)) {
                  if (f)
                    ...
                    switch (h = a.Selector.query(r), h.length) {
                      case 0:
                        h = null;
                        break;
                      case 1:
                  ...
                  if (!h)
                    return n = o.onAvailable(r, function() {
              ...
              detach: function(c, d, e) {
                ...
                if (g[g.length - 1] === k && (h = !0), c && c.detach)
                  return c.detach();
                if ("string" == typeof e && (h ? e = b.byId(e) : (e = a.Selector.query(e), i = e.length, 1 > i ? e = null : 1 == i && (e = e[0]))), !e)
                  return !1;
                if (e.detach)
                  return g.splice(2, 1), e.detach.apply(e, g);
                if (l(e)) {
                  for (j = !0, m = 0, i = e.length; i > m; ++m)
                    g[2] = e[m], j = a.Event.detach.apply(a.Event, g) && j;
                  return j;
                }
              ...
              _poll: function() {
                if (!o.locked) {
                  ...
                  }, c = 0, e = m.length; e > c; ++c)
                    f = m[c], f && !f.checkReady && (g = f.compat ? b.byId(f.id) : a.Selector.query(f.id, null, !0), g ? (j(g, f), m[c] = null) : i.push(f));
                  for (c = 0, e = m.length; e > c; ++c)
                    f = m[c], f && f.checkReady && (g = f.compat ? b.byId(f.id) : a.Selector.query(f.id, null, !0), g ? (d || g.get && g.get("nextSibling") || g.nextSibling) && (j(g, f), m[c] = null) : i.push(f));
              ...
              purgeElement: function(b, c, d) {
                var g,
                    ...
                    i,
                    j,
                    e = a.Lang.isString(b) ? a.Selector.query(b, null, !0) : b,
                    f = o.getListeners(e, d);
                if (c && e)
                  for (f = f || [], i = a.Selector.query("*", e), h = i.length, g = 0; h > g; ++g)
                    j = o.getListeners(i[g], d), j && (f = f.concat(j));
                if (f)
    ...
    var c,
        ...
        e = a.Object,
        g = {},
        h = a.CustomEvent.prototype,
        i = a.EventTarget.prototype,
        j = function(a, b) {
          var c;
          for (c in b)
            d.hasOwnProperty(c) || (a[c] = b[c]);
        };
    a.EventFacade = function(a, b) {
      ...
      var c,
          ...
          s = r.host || r,
          w = s._yuievt;
      if (v = r.stack, v && r.queuable && r.type !== v.next.type)
        return v.queue || (v.queue = []), v.queue.push([r, b]), !0;
      if (x = r.hasSubs() || w.hasTargets || r.broadcast, r.target = r.target || s, r.currentTarget = s, r.details = b.concat(), x) {
        if (c = v || {
          ...
          bubbling: null,
          type: r.type,
          defaultTargetOnly: r.defaultTargetOnly
        }, j = r.getSubs(), k = j[0], l = j[1], r.stopped = r.type !== c.type ? 0 : c.stopped, r.prevented = r.type !== c.type ? 0 : c.prevented, r.stoppedFn && (i = new a.EventTarget({
          fireOnce: !0,
          context: s
        }), r.events = i, i.on("stopped", r.stoppedFn)), r._facade = null, d = r._getFacade(b), k && r._procSubs(k, b, d), r.bubbles && s.bubble && !r.stopped && (u = c.bubbling, c.bubbling = r.type, c.type !== r.type && (c.stopped = 0, c.prevented = 0), h = s.bubble(r, b, null, c), r.stopped = Math.max(r.stopped, c.stopped), r.prevented = Math.max(r.prevented, c.prevented), c.bubbling = u), o = r.prevented, o ? (p = r.preventedFn, p && p.apply(s, b)) : (q = r.defaultFn, q && (!r.defaultTargetOnly && !c.defaultTargetOnly || s === d.target) && q.apply(s, b)), r.broadcast && r._broadcast(b), l && !r.prevented && r.stopped < 2)
          if (m = c.afterQueue, c.id === r.id || r.type !== w.bubbling) {
            if (r._procSubs(l, b, d), m)
              for (; t = m.last(); )
                t();
          } else
            n = l, c.execDefaultCnt && (n = a.merge(n), a.each(n, function(a) {
              a.postponed = !0;
        ...
        if (r.target = null, c.id === r.id) {
          if (f = c.queue)
            for (; f.length; )
              e = f.pop(), g = e[0], c.next = g, g._fire(e[1]);
          r.stack = null;
        }
        ...
        for (i in e)
          if (e.hasOwnProperty(i)) {
            if (g = e[i], h = g._yuievt.events[l], g._hasSiblings && (k = g.getSibling(l, h)), k && !h && (h = g.publish(l)), n = g._yuievt.bubbling, g._yuievt.bubbling = l, h) {
              if (k && (h.sibling = k), h.target = m, h.originalTarget = m, h.currentTarget = g, j = h.broadcast, h.broadcast = !1, h.emitFacade = !0, h.stack = d, f = f && h.fire.apply(h, b || a.details || []), h.broadcast = j, h.originalTarget = null, h.stopped)
                break;
            } else
              g._yuievt.hasTargets && g.bubble(a, b, m, d);
    ...
    c.prototype.fire = function(b) {
      ...
      prototype: {
        ...
        _subscribe: function(b, d, f, g, h) {
          var i = new a.CustomEvent(this.type, this.publishConfig),
              j = i.on.apply(i, f),
              k = new c(j, this.emitFacade),
              l = e.getRegistry(b, this.type, !0),
              m = j.sub;
          return m.node = b, m.filter = h, g && this.applyArgExtras(g, m), a.mix(i, {
            eventDef: this,
            notifier: k,
            host: b,
            currentTarget: b,
          ...
          }, !0), j.notifier = k, l.register(j), this[d](b, m, k, h), j;
        },
        ...
        _detach: function(b) {
          var e,
              ...
              c = b[2],
              d = k(c) ? m(c) : h(c);
          for (b.splice(2, 1), f = 0, g = d.length; g > f; ++f)
            if (e = a.one(d[f]), e && (i = this.getSubs(e, b)))
        ...
        getSubs: function(a, b, c, d) {
          var h,
              ...
              j,
              k,
              f = e.getRegistry(a, this.type),
              g = [];
          if (f)
            for (h = f.handles, c || (c = this.subMatch), i = 0, j = h.length; j > i; ++i)
              if (k = h[i], c.call(this, k.sub, b)) {
                if (d)
                  return k;
                g.push(h[i]);
              }
      ...
      }, a.extend(g, e, f), i = new g, b = i.type, a.Node.DOM_EVENTS[b] = a.Env.evt.plugins[b] = {
        eventDef: i,
        on: function() {
    ...
    a.augment(c, a.EventTarget, null, null, {
      ...
      preventable: !1,
      queueable: !0
    }), g._state || (g._state = {}), c.NAME = "historyBase", c.SRC_ADD = n, c.SRC_REPLACE = o, c.html5 = !!(k.history && k.history.pushState && k.history.replaceState && ("onpopstate" in k || a.UA.gecko >= 2) && (!a.UA.android || a.UA.android >= 2.4)), c.nativeHashChange = ("onhashchange" in k || "onhashchange" in i) && (!j || j > 7), a.mix(c.prototype, {
      _init: function(a) {
        var b;
        a = this._config = a || {}, this.force = !!a.force, b = this._initialState = this._initialState || a.initialState || null, this.publish(m, {
          broadcast: 2,
      ...
      _resolveChanges: function(a, b, c) {
        ...
        }, this)) : h = b !== i, (h || this.force) && this._fireEvents(a, {
          changed: e,
          newState: b,
          prevState: i,
          removed: j
    ...
    a.extend(c, d, {
      ...
      NAME: "historyhtml5",
      SRC_POPSTATE: h
    }), a.Node.DOM_EVENTS.popstate || (a.Node.DOM_EVENTS.popstate = 1), a.HistoryHTML5 = c, (g === !0 || g !== !1 && d.html5) && (a.History = c);
  }, "3.10.1", {
    optional: ["json"],
    requires: ["event-base", "history-base", "node-base"]
    ...
    var j,
        ...
        f = a.Array,
        g = a.Object,
        h = YUI.namespace("Env.HistoryHash"),
        i = "hash",
        m = a.config.win,
        n = a.config.useHistoryHTML5;
    a.extend(c, d, {
      _init: function(b) {
        var d = c.parseHash();
      ...
      parseHash: function(a) {
        var d,
            ...
            i = {},
            j = c.hashPrefix;
        for (a = e.isValue(a) ? a : c.getHash(), j && (k = a.indexOf(j), (0 === k || 1 === k && "#" === a.charAt(0)) && (a = a.replace(j, ""))), g = a.match(c._REGEX_HASH) || [], d = 0, f = g.length; f > d; ++d)
          h = g[d].split("="), i[b(h[0])] = b(h[1]);
        return i;
      },
    ...
    }), j = h._notifiers, j || (j = h._notifiers = []), a.Event.define("hashchange", {
      on: function(b, c, d) {
      ...
      k !== a && (d = c.getUrl(), b = {
        ...
        newHash: a,
        newUrl: d
      }, k = a, l = d, f.each(j.concat(), function(a) {
        a.fire(b);
      }));
    ...
    !function(a) {
      var b = "documentElement",
          ...
          m = (a.config.win, a.config.doc),
          n = void 0,
          o = a.DOM,
          p = "transform",
          q = "transformOrigin",
          r = ["WebkitTransform", "MozTransform", "OTransform", "msTransform"],
          s = /color$/i,
          t = /width|height|top|left|right|bottom|margin|padding/i;
      a.Array.each(r, function(a) {
        ...
        getStyle: function(a, b, c) {
          c = c || a.style;
          var d = o.CUSTOM_STYLES,
              e = "";
          if (c) {
            if (b in d) {
              if (d[b].get)
                return d[b].get(a, b, c);
      ...
      }, o.CUSTOM_STYLES.transformOrigin = {
        set: function(a, b, c) {
          c[q] = b;
        },
        get: function(a) {
    ...
    !function(a) {
      var q,
          ...
          o = a.DOM,
          p = /^t(?:able|d|h)$/i;
      a.UA.ie && (q = "BackCompat" !== a.config.doc[c] ? b : "body"), a.mix(o, {
        ...
        getXY: function() {
          return a.config.doc[b][m] ? function(d) {
            ...
            if (b)
              if (o.inDoc(b)) {
                for (c = [b.offsetLeft, b.offsetTop], f = b.ownerDocument, g = b, h = a.UA.gecko || a.UA.webkit > 519 ? !0 : !1; g = g.offsetParent; )
                  c[0] += g.offsetLeft, c[1] += g.offsetTop, h && (c = o._calcBorders(g, c));
                if (o.getStyle(b, d) != e) {
                  for (g = b; g = g.parentNode; )
                    i = g.scrollTop, j = g.scrollLeft, a.UA.gecko && "visible" !== o.getStyle(g, "overflow") && (c = o._calcBorders(g, c)), (i || j) && (c[0] -= j, c[1] -= i);
        ...
        _calcBorders: function(b, c) {
          var d = parseInt(o[n](b, l), 10) || 0,
              e = parseInt(o[n](b, k), 10) || 0;
        ...
        _getWinSize: function(d, e) {
          ...
          var f = e.defaultView || e.parentWindow,
              ...
              i = f.innerWidth,
              j = e[b];
          return g && !a.UA.opera && ("CSS1Compat" != g && (j = e.body), h = j.clientHeight, i = j.clientWidth), {
            height: h,
            width: i
          };
        },
        _getDocSize: function(d) {
          var e = d ? o._getDoc(d) : a.config.doc,
              f = e[b];
          return "CSS1Compat" != e[c] && (f = e.body), {
      ...
      a.mix(g, {
        ...
        intersect: function(h, i, j) {
          ...
          return n = f(l, k), {
            ...
            bottom: n[d],
            left: n[e],
            area: (n[d] - n[b]) * (n[c] - n[e]),
            yoff: n[d] - n[b],
            xoff: n[c] - n[e],
            inRegion: g.inRegion(h, i, !1, j)
          };
        },
    ...
    function c(b, e, i, k) {
      ...
      if (g(b)) {
        if (u = [], h(b))
          for (s = 0, t = b.length; t > s; ++s)
            l[0] = b[s], u.push(a.delegate.apply(a, l));
        else {
          l.unshift(null);
          for (s in b)
            b.hasOwnProperty(s) && (l[0] = s, l[1] = b[s], u.push(a.delegate.apply(a, l)));
        }
    ...
    c.notifySub = function(b, e, f) {
      ...
      var h,
          ...
          j,
          k,
          g = c._applyFilter(this.filter, e, f);
      if (g) {
      ...
      var g = d[0],
          h = e.el,
          j = g.target || g.srcElement,
          k = [],
          l = !1;
      if (3 === j.nodeType && (j = j.parentNode), j.disabled && c._disabledRE.test(j.nodeName))
        return k;
      if (d.unshift(j), f(b))
        for (; j && (l = j === h, i(j, b, l ? null : h) && k.push(j), !l); )
          j = j.parentNode;
      else {
        for (d[0] = a.one(j), d[1] = new a.DOMEventFacade(g, h, e); j && (b.apply(d[0], d) && k.push(j), j !== h); )
          j = j.parentNode, d[0] = a.one(j);
        d[1] = g;
      }
    ...
    a.Node.prototype.delegate = function(b) {
      var c = a.Array(arguments, 0, !0),
          d = a.Lang.isObject(b) && !a.Lang.isArray(b) ? 1 : 2;
    ...
    c.lastIndexOf = d._isNative(e.lastIndexOf) ? function(a, b, c) {
      ...
      var d = a.length,
          e = d - 1;
      if ((c || 0 === c) && (e = Math.min(0 > c ? d + c : c, d)), e > -1 && d > 0)
        for (; e > -1; --e)
          if (e in a && a[e] === b)
            return e;
      return -1;
      ...
      var f,
          ...
          e = [];
      a: for (; d > c; c++) {
        for (i = a[c], f = 0, h = e.length; h > f; f++)
          if (g = e[f], b) {
            if (b.call(a, i, g, c, a))
              continue a;
          } else if (i === g)
      ...
      for (var g,
          ...
          e = a.length,
          f = []; e > d; ++d)
        d in a && (g = a[d], b.call(c, g, d, a) && f.push(g));
      return f;
      ...
      for (var d = 0,
          f = a.length,
          g = e.concat.call(a); f > d; ++d)
        d in a && (g[d] = b.call(c, a[d], d, a));
      return g;
      ...
      if (!a)
        return b;
      for (e = 0, f = a.length; f > e; ++e)
        g = a[e], d.isArray(g) ? b.push.apply(b, c.flatten(g)) : b.push(g);
      return b;
    };
    ...
    c.INVALID_VALUE = {}, t = c.INVALID_VALUE, c._ATTR_CFG = [h, g, l, m, n, j, i, o, q], c.protectAttrs = function(b) {
      if (b) {
        b = a.merge(b);
        for (var c in b)
          b.hasOwnProperty(c) && (b[c] = a.merge(b[c]));
      }
      return b;
    }, c.prototype = {
      ...
      _setAttrVal: function(a, b, c, d, f, g) {
        var p,
            ...
            h = this,
            i = !0,
            j = g || this._state.data[a] || {},
            k = j.validator,
            l = j.setter,
            m = j.initializing,
            n = this._getStateVal(a, j),
            o = b || a;
      ...
      _setAttrs: function(a, b) {
        var c;
        for (c in a)
          a.hasOwnProperty(c) && this.set(c, a[c], b);
        return this;
      },
      getAttrs: function(a) {
      ...
      _getAttrs: function(a) {
        var c,
            ...
            b = {},
            g = a === !0;
        for ((!a || g) && (a = d.keys(this._state.data)), e = 0, f = a.length; f > e; e++)
          c = a[e], g && this._getStateVal(c) == this._state.get(c, r) || (b[c] = this.get(c));
        return b;
      },
      ...
      _addAttrs: function(a, b, c) {
        var f,
            ...
            e = this._tVals;
        for (f in a)
          a.hasOwnProperty(f) && (g = a[f], g.defaultValue = g.value, h = this._getAttrInitVal(f, g, e), void 0 !== h && (g.value = h), d[f] && (d[f] = void 0), this.addAttr(f, g, c));
      },
      ...
      _normAttrVals: function(a) {
        ...
        b = {};
        for (h in a)
          a.hasOwnProperty(h) && (-1 !== h.indexOf(f) ? (d = h.split(f), e = d.shift(), c = c || {}, g = c[e] = c[e] || [], g[g.length] = {
            path: d,
            value: a[h]
          }) : b[h] = a[h]);
        return {
      ...
      _getAttrInitVal: function(a, b, c) {
        var g,
            ...
            h = !1,
            i = b.readOnly;
        if (!i && c && (j = c.simple, j && j.hasOwnProperty(a) && (e = j[a], h = !0)), f && !h && (f.call || (f = this[f]), f && (g = f.call(this, a), e = g)), !i && c && (k = c.complex, k && k.hasOwnProperty(a) && void 0 !== e && null !== e))
          for (p = k[a], l = 0, m = p.length; m > l; ++l)
            n = p[l].path, o = p[l].value, d.setValue(e, n, o);
        return e;
      },
      _initAttrs: function(b, c, d) {
        ...
        var e = a.Base,
            f = a.BaseCore,
            g = e && a.instanceOf(this, e),
            h = !g && f && a.instanceOf(this, f);
    ...
    c.prototype = {
      modifyAttr: function(a, b) {
        ...
        if (c.attrAdded(a)) {
          ...
          for (f in b)
            g[f] && b.hasOwnProperty(f) && (h.add(a, f, b[f]), f === d && h.remove(a, e));
        }
      },
    ...
    c._ATTR_CFG = o._ATTR_CFG.concat("cloneDefaultValue"), c._NON_ATTRS_CFG = ["plugins"], c.NAME = "baseCore", c.ATTRS = {
      initialized: {
        readOnly: !0,
        value: !1
      },
      ...
      if (d = b.ATTRS || (b.ATTRS = {}), c) {
        ...
        for (f in c)
          c.hasOwnProperty(f) && (e = d[f] || (d[f] = {}), a.mix(e, c[f], !0));
      }
    }, c.prototype = {
      ...
      _filterAttrCfgs: function(a, b) {
        var e,
            ...
            k,
            c = null,
            l = this._filteredAttrs,
            m = a.ATTRS;
        if (m)
          for (j in m)
            if (k = b[j], k && !l.hasOwnProperty(j) && (c || (c = {}), e = c[j] = p({}, k, this._attrCfgHash()), l[j] = !0, f = e.value, f && "object" == typeof f && this._cloneDefaultValue(j, e), b._subAttrs && b._subAttrs.hasOwnProperty(j))) {
              h = b._subAttrs[j];
              for (i in h)
                g = h[i], g.path && d.setValue(e.value, g.path, g.value);
            }
        return c;
      },
      _filterAdHocAttrs: function(a, b) {
        ...
        if (b) {
          c = {};
          for (e in b)
            !a[e] && !d[e] && b.hasOwnProperty(e) && (c[e] = {value: b[e]});
        }
        return c;
      },
      _initHierarchyData: function() {
        ...
        if (c = a, !b) {
          for (; c; ) {
            if (k[k.length] = c, c.ATTRS && (l[l.length] = c.ATTRS), h && (f = c._ATTR_CFG, g = g || {}, f))
              for (d = 0, e = f.length; e > d; d += 1)
                g[f[d]] = !0;
            if (i = c._NON_ATTRS_CFG)
              for (d = 0, e = i.length; e > d; d++)
                j[i[d]] = !0;
            c = c.superclass ? c.superclass.constructor : null;
          }
          h && (a._ATTR_CFG_HASH = g), b = a._CACHED_CLASS_DATA = {
            classes: k,
            nonAttrs: j,
            attrs: this._aggregateAttrs(l)
          };
        }
      ...
      _aggregateAttrs: function(a) {
        ...
        if (a)
          for (h = a.length - 1; h >= 0; --h) {
            c = a[h];
            for (b in c)
              c.hasOwnProperty(b) && (e = p({}, c[b], i), g = null, -1 !== b.indexOf(f) && (g = b.split(f), b = g.shift()), k = l[b], g && k && k.value ? (d = l._subAttrs, d || (d = l._subAttrs = {}), d[b] || (d[b] = {}), d[b][g.join(f)] = {
                value: e.value,
                path: g
              }) : g || (k ? (k.valueFn && j in e && (k.valueFn = null), p(k, e, i)) : l[b] = e));
          }
        return l;
      },
      _initHierarchy: function(a) {
        var c,
            ...
            h,
            j,
            b = this._lazyAddAttrs,
            k = this._getClasses(),
            l = this._getAttrCfgs(),
            m = k.length - 1;
        for (this._filteredAttrs = {}, e = m; e >= 0; e--) {
          if (c = k[e], d = c.prototype, j = c._yuibuild && c._yuibuild.exts, j)
            for (f = 0, g = j.length; g > f; f++)
              j[f].apply(this, arguments);
          if (this.addAttrs(this._filterAttrCfgs(c, l), a, b), this._allowAdHocAttrs && e === m && this.addAttrs(this._filterAdHocAttrs(l, a), a, b), d.hasOwnProperty(i) && d.initializer.apply(this, arguments), j)
            for (f = 0; g > f; f++)
              h = j[f].prototype, h.hasOwnProperty(i) && h.initializer.apply(this, arguments);
        }
      ...
      _destroyHierarchy: function() {
        ...
        for (c = 0, d = i.length; d > c; c++) {
          if (a = i[c], b = a.prototype, g = a._yuibuild && a._yuibuild.exts, g)
            for (e = 0, f = g.length; f > e; e++)
              h = g[e].prototype, h.hasOwnProperty(n) && h.destructor.apply(this, arguments);
    ...
    var d = a.Lang,
        ...
        g = "bubbleTargets",
        h = "_bubbleTargets",
        i = a.AttributeObservable,
        j = a.BaseCore;
    c._ATTR_CFG = i._ATTR_CFG.concat(), c._NON_ATTRS_CFG = ["on", "after", "bubbleTargets"], c.prototype = {
      _initAttribute: function() {
      ...
      _preInitEventCfg: function(a) {
        ...
        var b,
            ...
            f = a && g in a;
        if (f || h in this)
          if (e = f ? a && a.bubbleTargets : this._bubbleTargets, d.isArray(e))
      ...
      destroy: function() {
        ...
        }), this.fire(e), this.detachAll(), this;
      },
    ...
    g._build = function(b, c, d, e, f, h) {
      var p,
          ...
          m = k._cfg(c, h, d),
          n = k._mixCust,
          o = l._yuibuild.dynamic;
      for (p = 0, q = d.length; q > p; p++)
        r = d[p], s = r.prototype, t = s[i], u = s[j], delete s[i], delete s[j], a.mix(l, r, !0, null, 1), n(l, r, m), t && (s[i] = t), u && (s[j] = u), l._yuibuild.exts.push(r);
      ...
      _mixCust: function(b, c, d) {
        var e,
            ...
            j,
            k;
        if (d && (e = d.aggregates, f = d.custom, g = d.statics), g && a.mix(b, c, !0, g), e)
          for (k = 0, j = e.length; j > k; k++)
            i = e[k], !b.hasOwnProperty(i) && c.hasOwnProperty(i) && (b[i] = h.isArray(c[i]) ? [] : {}), a.aggregate(b, c, !0, [i]);
        if (f)
          for (k in f)
            f.hasOwnProperty(k) && f[k](k, b, c);
      },
      _tmpl: function(b) {
        function c() {
          c.superclass.constructor.apply(this, arguments);
      ...
      _impl: function(a) {
        ...
        for (c = 0, d = b.length; d > c; c++)
          if (e = b[c], e._yuibuild)
            for (f = e._yuibuild.exts, g = f.length, h = 0; g > h; h++)
              if (f[h] === a)
                return !0;
        return !1;
      },
      ...
      _cfg: function(b, c, d) {
        for (var h,
            ...
            k = c && c.statics,
            l = b; l && l.prototype; )
          h = l._buildCfg, h && (h.aggregates && (e = e.concat(h.aggregates)), h.custom && a.mix(f, h.custom, !0), h.statics && (g = g.concat(h.statics))), l = l.superclass ? l.superclass.constructor : null;
        if (d)
          for (m = 0, n = d.length; n > m; m++)
            l = d[m], h = l._buildCfg, h && (h.aggregates && (e = e.concat(h.aggregates)), h.custom && a.mix(f, h.custom, !0), h.statics && (g = g.concat(h.statics)));
        return i && (e = e.concat(i)), j && a.mix(f, c.cfgBuild, !0), k && (g = g.concat(k)), {
          aggregates: e,
          custom: f,
          statics: g
        };
      ...
      _clean: function(b, c) {
        ...
        for (e = 0, f = h.length; f > e; e++)
          d = h[e], g.hasOwnProperty(d) && delete g[d];
        return g;
      }
    ...
    if (a.UA.ie && !a.HistoryBase.nativeHashChange) {
      var c = a.Do,
          d = YUI.namespace("Env.HistoryHash"),
          e = a.HistoryHash,
          f = d._iframe,
          g = a.config.win;
      e.getIframeHash = function() {
        if (!f || !f.contentWindow)
          return "";
        var a = e.hashPrefix,
            b = f.contentWindow.location.hash.substr(1);
        return a && 0 === b.indexOf(a) ? b.replace(a, "") : b;
      }, e._updateIframe = function(a, b) {
        var c = f && f.contentWindow && f.contentWindow.document,
            d = c && c.location;
    ...
    var d = a.HistoryHash,
        ...
        i = [],
        j = "ready";
    a.Router = a.extend(c, a.Base, {
      _regexPathParam: /([:*])([\w\-]+)?/g,
      _regexUrlQuery: /\?([^#]*).*$/,
      _regexUrlOrigin: /^(?:[^\/#?:]+:\/\/|\/\/)[^\/]*/,
      initializer: function(b) {
        var c = this;
        c._html5 = c.get("html5"), c._routes = [], c._url = c._getURL(), c._setRoutes(b && b.routes ? b.routes : c.get("routes")), c._html5 ? (c._history = new a.HistoryHTML5({force: !0}), c._historyEvents = a.after("history:change", c._afterHistoryChange, c)) : c._historyEvents = a.on("hashchange", c._afterHistoryChange, g, c), c.publish(j, {
          defaultFn: c._defReadyFn,
          fireOnce: !0,
          preventable: !1
        }), c.once("initializedChange", function() {
      ...
      _normalizePath: function(a) {
        ...
        if (!a || a === c)
          return c;
        for (g = a.split(c), i = [], d = 0, e = g.length; e > d; ++d)
          h = g[d], h === b ? i.pop() : h && i.push(h);
      ...
      _upgradeURL: function(b) {
        if (!this._hasSameOrigin(b))
          return b;
        var e,
            c = (b.match(/#(.*)$/) || [])[1] || "",
            d = a.HistoryHash.hashPrefix;
      ...
      html5: a.HistoryBase.html5 && (!a.UA.android || a.UA.android >= 3),
      _instances: h,
      dispatch: function() {
        var a,
            b,
            c;
        for (a = 0, b = h.length; b > a; a += 1)
          c = h[a], c && c._dispatch(c._getPath(), c._getURL());
      }
    }), a.Controller = a.Router;
  }, "3.10.1", {
    optional: ["querystring-parse"],
    requires: ["array-extras", "base-build", "history"]
  }), YUI.add("pjax-base", function(a) {
    function c() {}
    var d = a.config.win,
        e = a.ClassNameManager.getClassName("pjax"),
        f = "navigate";
    c.prototype = {
      _regexURL: /^((?:[^\/#?:]+:\/\/|\/\/)[^\/]*)?([^?#]*)(\?[^#]*)?(#.*)?$/,
      initializer: function() {
      ...
      _navigate: function(b, c) {
        if (b = this._upgradeURL(b), !this.hasRoute(b))
          return !1;
        c = a.merge(c, {url: b});
        var g,
            h,
    ...
    c.stringify = function(b, c) {
      ...
      for (g in b)
        if (b.hasOwnProperty(g))
          if (a.Lang.isArray(b[g]))
            for (h = 0, i = b[g].length; i > h; h++)
              e.push(d(f ? g + "[]" : g) + "=" + d(b[g][h]));
          else
            e.push(d(g) + "=" + d(b[g]));
      return e.join("&");
    };
    ...
    var d = ["start", "complete", "end", "success", "failure", "progress"],
    ...
    c.prototype = {
      ...
      _init: function(b) {
        var e,
            f,
            c = this;
        for (c.cfg = b || {}, a.augment(c, a.EventTarget), e = 0, f = d.length; f > e; ++e)
          c.publish("io:" + d[e], a.merge({broadcast: 1}, b)), c.publish("io-trn:" + d[e], b);
      },
      _create: function(b, c) {
        var i,
            d = this,
            e = {
              id: a.Lang.isNumber(c) ? c : d._id++,
              uid: d._uid
            },
            g = b.xdr ? b.xdr.use : null,
            h = b.form && b.form.upload ? "iframe" : null;
      ...
      _evt: function(b, c, e) {
        ...
        this.detach(k), c.e && (c.c = {
          ...
          cfg: e,
          arguments: h
        } : c.id], i || (b === d[0] || b === d[2] ? h && g.push(h) : (c.evt ? g.push(c.evt) : g.push(c.c), h && g.push(h))), g.unshift(j), f.fire.apply(f, g), e.on && (g[0] = k, f.once(k, e.on[b], e.context || a), f.fire.apply(f, g));
      },
      start: function(a, b) {
        this._evt(d[0], a, b);
      },
      ...
      send: function(b, c, d) {
        ...
        try {
          ...
          if (f.xdr)
            return m._retry(f, b, c);
          m.complete(f, c), m._result(f, c);
        }
        return c.timeout && m._startTimeout(f, c.timeout), {
          id: f.id,
          abort: function() {
    ...
    var h = f && f.XMLHttpRequest,
        i = f && f.XDomainRequest,
        j = f && f.ActiveXObject,
        k = h && "withCredentials" in new XMLHttpRequest;
    a.mix(a.IO, {
      _default: "xhr",
    ...
    c.prototype = {
      getContent: function(b) {
        var g,
            c = {},
            d = this.get("contentSelector"),
            e = a.Node.create(b || ""),
            f = this.get("titleSelector");
      ...
      _onPjaxIOComplete: function(a, b, c) {
        var d = this.getContent(b.responseText),
            e = c.route,
            f = e.req,
            g = e.res;
      ...
      addPjaxParam: {value: !0},
      contentSelector: {value: null},
      titleSelector: {value: "title"},
      timeout: {value: 3e4}
    }, a.PjaxContent = c;
  }, "3.10.1", {requires: ["io-base", "node-base", "router"]}), YUI.add("pjax", function(a) {
    var c = ["loadContent", "_defaultRoute"],
        d = "error",
        e = "load";
    a.Pjax = a.Base.create("pjax", a.Router, [a.PjaxBase, a.PjaxContent], {
      initializer: function() {
    ...
    c.prototype = {
      plug: function(a, b) {
        ...
        if (d.isArray(a))
          ...
          a && !d.isFunction(a) && (b = a.cfg, a = a.fn), a && a.NS && (f = a.NS, b = b || {}, b.host = this, this.hasPlugin(f) ? this[f].setAttrs && this[f].setAttrs(b) : (this[f] = new a(b), this._plugins[f] = a));
        return this;
      },
      unplug: function(a) {
        var b = a,
            c = this._plugins;
        if (a)
          d.isFunction(a) && (b = a.NS, b && (!c[b] || c[b] !== a) && (b = null)), b && (this[b] && (this[b].destroy && this[b].destroy(), delete this[b]), c[b] && delete c[b]);
        else
          for (b in this._plugins)
            this._plugins.hasOwnProperty(b) && this.unplug(b);
        return this;
      },
    ...
    c.prototype._initConfigPlugins = function(b) {
      var f,
          ...
          i,
          j,
          c = this._getClasses ? this._getClasses() : [this.constructor],
          d = [],
          e = {};
      for (g = c.length - 1; g >= 0; g--)
        f = c[g], i = f._UNPLUG, i && a.mix(e, i, !0), h = f._PLUG, h && a.mix(d, h, !0);
      for (j in d)
        d.hasOwnProperty(j) && (e[j] || this.plug(d[j]));
      ...
      var f,
          ...
          i;
      if (b !== a.Base)
        for (b._PLUG = b._PLUG || {}, d.isArray(c) || (e && (c = {
          fn: c,
          cfg: e
        }), c = [c]), g = 0, h = c.length; h > g; g++)
          f = c[g], i = f.NAME || f.fn.NAME, b._PLUG[i] = f;
      ...
      var e,
          ...
          h;
      if (b !== a.Base)
        for (b._UNPLUG = b._UNPLUG || {}, d.isArray(c) || (c = [c]), f = 0, g = c.length; g > f; f++)
          e = c[f], h = e.NAME, b._PLUG[h] ? delete b._PLUG[h] : b._UNPLUG[h] = e;
    };
        ...
        _notify: function(b) {
          ...
          for (d.clearData(i), f.push(d), h && f.unshift(h), f._nodes.reverse(), k && (q = k, f.some(function(b) {
            var f,
                ...
                d = e[c];
            if (d)
              for (k--, f = 0, g = d.length; g > f; ++f)
                d[f].handle.sub.filter && j.push(d[f]);
            return !k;
          }), k = q); k && (l = f.shift()); ) {
            ...
            if (2 !== b.stopped)
              for (r = 0, s = j.length; s > r && (n = j[r], t = n.handle.sub, t.filter.apply(l, [l, b].concat(t.args || [])) && (b.container = n.container, b.currentTarget = l, u = n.fire(b)), u !== !1 && 2 !== b.stopped); ++r)
                ;
            if (b.stopped)
              break;
          }
        ...
        f = {
          ...
          _poll: function(b, d) {
            var j,
                ...
                h = e && e.value,
                i = b._data && b._data[c];
            return e && i ? (k = i.prevVal, h !== k && (i.prevVal = h, j = {
              _event: g,
              currentTarget: g && g.currentTarget || b,
              newVal: h,
              prevVal: k,
              target: g && g.target || b
            }, a.Object.each(i.notifiers, function(a) {
              a.fire(j);
          ...
          _startPolling: function(b, e, g) {
            if (b.test("input,textarea")) {
              ...
              if (h || (h = {prevVal: b.get(d)}, b.setData(c, h)), h.notifiers || (h.notifiers = {}), h.interval) {
                if (!g.force)
                  return h.notifiers[a.stamp(e)] = e, void 0;
                f._stopPolling(b, e);
              }
          ...
          _onKeyUp: function(a, b) {
            (229 === a.charCode || 197 === a.charCode) && f._startPolling(a.currentTarget, b, {
              e: a,
              force: !0
            });
          },
          ...
          _onSubscribe: function(b, e, g, h) {
            ...
            if (j = {
              blur: f._onBlur,
              focus: f._onFocus,
              keydown: f._onKeyDown,
              keyup: f._onKeyUp,
              mousedown: f._onMouseDown
            }, i = g._valuechange = {}, h)
              i.delegated = !0, i.getNodes = function() {
    ...
    e = {
      detach: f._onUnsubscribe,
      on: f._onSubscribe,
      delegate: f._onSubscribe,
      detachDelegate: f._onUnsubscribe,
      publishConfig: {emitFacade: !0}
    }, a.Event.define("valuechange", e), a.Event.define("valueChange", e), a.ValueChange = f;
    ...
    var d = a.Escape,
        ...
        i = e.isString,
        j = e.trim,
        k = a.Attribute.INVALID_VALUE,
        l = "_functionValidator",
        m = "_sourceSuccess",
        n = "allowBrowserAutocomplete",
        o = "inputNode",
        p = "query",
        q = "queryDelimiter",
        r = "requestTemplate",
    ...
    c.prototype = {
      ...
      sendRequest: function(b, c) {
        var d,
            e = this.get("source");
        return b || "" === b ? this._set(p, b) : b = this.get(p) || "", e && (c || (c = this.get(r)), d = c ? c.call(this, b) : b, e.sendRequest({
          query: b,
          request: d,
          callback: {success: a.bind(this._onResponse, this, b)}
        })), this;
      },
      ...
      _parseResponse: function(a, b, c) {
        ...
        if (h && f && (h = f.call(this, h)), h && h.length) {
          for (i = this.get("resultFilters"), s = this.get("resultTextLocator"), n = 0, o = h.length; o > n; ++n)
            q = h[n], r = s ? s.call(this, q) : q.toString(), g.push({
              display: d.html(r),
              raw: q,
              text: r
            });
          for (n = 0, o = i.length; o > n; ++n) {
            if (g = i[n].call(this, a, g.concat()), !g)
              return;
            if (!g.length)
              break;
          }
          if (g.length) {
            if (k = this.get("resultFormatter"), m = this.get("resultHighlighter"), p = this.get("maxResults"), p && p > 0 && g.length > p && (g.length = p), m) {
              if (l = m.call(this, a, g.concat()), !l)
                return;
              for (n = 0, o = l.length; o > n; ++n)
                q = g[n], q.highlighted = l[n], q.display = q.highlighted;
            }
            if (k) {
              if (j = k.call(this, a, g.concat()), !j)
                return;
      ...
      _setSource: function(b) {
        var f,
            d = this.get("sourceType") || e.type(b);
      ...
      _afterValueChange: function(a) {
        ...
        }, f ? (clearTimeout(d._delay), d._delay = setTimeout(g, f)) : g()) : d._set(p, i) : (clearTimeout(d._delay), d.fire(w, {
          prevVal: a.prevVal ? d._parseValue(a.prevVal) : null,
          src: a.src
        }));
      },
      _onInputBlur: function() {
        ...
        if (b && !this.get("allowTrailingDelimiter")) {
          if (b = e.trimRight(b), f = d = this._inputNode.get(u), b)
            for (; (d = e.trimRight(d)) && (c = d.length - b.length) && d.lastIndexOf(b) === c; )
              d = d.substring(0, c);
          else
            d = e.trimRight(d);
          d !== f && this.set(u, d);
    ...
    }, c.UI_SRC = a.Widget && a.Widget.UI_SRC || "ui", a.AutoCompleteBase = c;
  }, "3.10.1", {
    optional: ["autocomplete-sources"],
    requires: ["array-extras", "base-build", "escape", "event-valuechange", "node-base"]
  }), YUI.add("text-data-wordbreak", function(a) {
    ...
    var c = a.Text,
        ...
        p = 11,
        q = 12,
        r = [new RegExp(d.aletter), new RegExp(d.midnumlet), new RegExp(d.midletter), new RegExp(d.midnum), new RegExp(d.numeric), new RegExp(d.cr), new RegExp(d.lf), new RegExp(d.newline), new RegExp(d.extend), new RegExp(d.format), new RegExp(d.katakana), new RegExp(d.extendnumlet)],
        s = "",
        t = new RegExp("^" + d.punctuation + "$"),
        u = /\s/,
        v = {
          getWords: function(a, b) {
            var h,
                ...
                f = [],
                g = [];
            for (b || (b = {}), b.ignoreCase && (a = a.toLowerCase()), i = b.includePunctuation, j = b.includeWhitespace; e > c; ++c)
              h = a.charAt(c), f.push(h), v._isWordBoundary(d, c) && (f = f.join(s), f && (j || !u.test(f)) && (i || !t.test(f)) && g.push(f), f = []);
            return g;
          },
          ...
          _classify: function(a) {
            for (var b,
                ...
                g = a.length,
                h = r.length; g > d; ++d) {
              for (b = a.charAt(d), i = q, e = 0; h > e; ++e)
                if (f = r[e], f && f.test(b)) {
                  i = e;
                  break;
                }
        ...
        i = {
          ...
          all: function(a, b, c) {
            var h,
                ...
                n,
                e = [];
            for (c || (c = g), h = c.escapeHTML !== !1, m = c.startsWith ? i._START_REGEX : i._REGEX, n = c.replacer || i._REPLACER, b = f(b) ? b : [b], j = 0, k = b.length; k > j; ++j)
              l = b[j], l && e.push(d.regex(h ? d.html(l) : l));
    ...
    var c = a.Array,
        d = a.Highlight,
        e = a.mix(a.namespace("AutoCompleteHighlighters"), {
          charMatch: function(a, b, e) {
    ...
    a.mix(c.prototype, {
      ...
      _createYQLSource: function(b) {
        function c(c) {
          var k,
              ...
              j = g.get(f);
          return n = d.sub(b, {
            maxResults: j > 0 ? j : 1e3,
            request: c.request,
            query: h
          }), g._cache && n in g._cache ? (g[e](g._cache[n], c), void 0) : (k = function(a) {
            g._cache && (g._cache[n] = a), g[e](a, c);
          }, m = {proto: g.get("yqlProtocol")}, l ? (l._callback = k, l._opts = m, l._params.q = n, i && (l._params.env = i)) : l = new a.YQLRequest(n, {
            on: {success: k},
            allowCache: !1
          }, i ? {env: i} : null, m), l.send(), void 0);
        }
        var j,
            k,
            l,
      ...
      _jsonpFormatter: function(a, b, c) {
        var e = this.get(f),
            h = this.get(g);
        return h && (a += h(c)), d.sub(a, {
          callback: b,
          maxResults: e > 0 ? e : 1e3,
        ...
        h = {
          ...
          processArgs: function(b) {
            var h,
                ...
                k,
                c = b.splice(3, 1)[0],
                d = a.Array.hash(c.match(/\+(?:alt|ctrl|meta|shift)\b/g) || []),
                e = {
                  type: this._typeRE.test(c) ? RegExp.$1 : null,
                  mods: d,
                  keys: null
                },
                f = c.replace(this._keysRE, "");
            if (f)
              for (f = f.split(","), e.keys = {}, k = f.length - 1; k >= 0; --k)
                h = g(f[k]), h && (+h == h ? e.keys[h] = d : (j = h.toLowerCase(), this.KEY_MAP[j] ? (e.keys[this.KEY_MAP[j]] = d, e.type || (e.type = "down")) : (h = h.charAt(0), i = h.toUpperCase(), d["+shift"] && (h = i), e.keys[h.charCodeAt(0)] = h === i ? a.merge(d, {"+shift": !0}) : d)));
    ...
    var c = a.Attribute;
    c.Complex = function() {}, c.Complex.prototype = {
    ...
    c.ATTRS = {host: {writeOnce: !0}}, c.NAME = "plugin", c.NS = "plugin", a.extend(c, a.Base, {
      _handles: null,
      initializer: function() {
        this._handles = [];
      },
      destructor: function() {
        if (this._handles)
          for (var a = 0,
              b = this._handles.length; b > a; a++)
            this._handles[a].detach();
      },
    ...
    !function() {
      function b(b, c, d, e, f, g, m, n, o, p, q) {
        if (b || a.error("simulateKeyEvent(): Invalid target."), i(c))
        ...
        if (h(a.config.doc.createEvent)) {
          ...
          k(a.config.doc.createEventObject) ? (r = a.config.doc.createEventObject(), r.bubbles = d, r.cancelable = e, r.view = f, r.ctrlKey = g, r.altKey = m, r.shiftKey = n, r.metaKey = o, r.keyCode = q > 0 ? q : p, b.fireEvent("on" + c, r)) : a.error("simulateKeyEvent(): No event simulation framework present.");
      }
    ...
    c.defaults = a.mix({
    ...
    }, a.config.queueDefaults || {}), a.extend(c, a.EventTarget, {
      _running: !1,
      _init: function() {
      ...
      next: function() {
        for (var a; this._q.length && (a = this._q[0] = this._prepare(this._q[0]), a && a.until()); )
          this.fire(e, {callback: a}), a = null;
        return a || null;
      },
      ...
      _prepare: function(b) {
        if (i(b) && b._prepared)
          return b;
        var d = a.merge(c.defaults, {
          context: this,
          args: [],
          _prepared: !0
        }, this.defaults, i(b) ? {fn: b} : b),
            e = a.bind(function() {
      ...
      run: function() {
        var a,
            b = !0;
        for (a = this.next(); b && a && !this.isRunning(); a = this.next())
          b = a.timeout < 0 ? this._execute(a) : this._schedule(a);
      ...
      indexOf: function(a) {
        for (var d,
            b = 0,
            c = this._q.length; c > b; ++b)
          if (d = this._q[b], d === a || d.id === a)
            return b;
        return -1;
      },
      ...
      _defPromoteFn: function(a) {
        var b = this.indexOf(a.callback),
            c = b > -1 ? this._q.splice(b, 1)[0] : null;
    ...
    var h,
        ...
        k,
        b = "gesture-simulate",
        d = a.config.win && "ontouchstart" in a.config.win && !a.UA.phantomjs && !(a.UA.chrome && a.UA.chrome < 6),
        e = {
          tap: 1,
          doubletap: 1,
          press: 1,
    ...
    c.prototype = {
        ...
        for (a.Lang.isNumber(j) || (j = 0), a.AsyncQueue.defaults.timeout = t, k = new a.AsyncQueue, z = d[0], A = d[1], E = h, F = h + j, H.start = [z + w * Math.sin(this._toRadian(E)), A - w * Math.cos(this._toRadian(E))], H.end = [z + x * Math.sin(this._toRadian(F)), A - x * Math.cos(this._toRadian(F))], I.start = [z - w * Math.sin(this._toRadian(E)), A + w * Math.cos(this._toRadian(E))], I.end = [z - x * Math.sin(this._toRadian(F)), A + x * Math.cos(this._toRadian(F))], B = 1, C = f / e, k.add({
          fn: function() {
            ...
            b = {
              ...
              clientX: I.start[0],
              clientY: I.start[1]
            }, e = this._createTouchList([a.merge({identifier: v++}, b), a.merge({identifier: v++}, c)]), d = {
              pageX: (H.start[0] + I.start[0]) / 2,
              pageY: (H.start[0] + I.start[1]) / 2,
              clientX: (H.start[0] + I.start[0]) / 2,
              clientY: (H.start[0] + I.start[1]) / 2
            }, this._simulateEvent(this.target, m, a.merge({
              touches: e,
              targetTouches: e,
              changedTouches: e,
              scale: B,
              rotation: E
            }, d)), a.UA.ios >= 2 && this._simulateEvent(this.target, p, a.merge({
              scale: B,
              rotation: E
            }, d));
          },
          timeout: 0,
          context: this
        }), J = Math.floor(g / t), y = (x - w) / J, D = (C - B) / J, G = (F - E) / J, K = function(b) {
          var j,
              k,
              l,
              m,
              c = w + y * b,
              d = z + c * Math.sin(this._toRadian(E + G * b)),
              e = A - c * Math.cos(this._toRadian(E + G * b)),
              f = z - c * Math.sin(this._toRadian(E + G * b)),
              g = A + c * Math.cos(this._toRadian(E + G * b)),
              h = (d + f) / 2,
              i = (e + g) / 2;
          j = {
            pageX: d,
            ...
            clientX: f,
            clientY: g
          }, m = this._createTouchList([a.merge({identifier: v++}, j), a.merge({identifier: v++}, k)]), l = {
            pageX: h,
            pageY: i,
            clientX: h,
            clientY: i
          }, this._simulateEvent(this.target, n, a.merge({
            touches: m,
            targetTouches: m,
            changedTouches: m,
            scale: B + D * b,
            rotation: E + G * b
          }, l)), a.UA.ios >= 2 && this._simulateEvent(this.target, q, a.merge({
            scale: B + D * b,
            rotation: E + G * b
          }, l));
        }, s = 0; J > s; s++)
        ...
        k.add({
          fn: function() {
            ...
            c = {
              ...
              clientX: I.end[0],
              clientY: I.end[1]
            }, f = this._createTouchList([a.merge({identifier: v++}, c), a.merge({identifier: v++}, d)]), e = {
              pageX: (H.end[0] + I.end[0]) / 2,
              pageY: (H.end[0] + I.end[1]) / 2,
              clientX: (H.end[0] + I.end[0]) / 2,
              clientY: (H.end[0] + I.end[1]) / 2
            }, a.UA.ios >= 2 && this._simulateEvent(this.target, r, a.merge({
              scale: C,
              rotation: F
            }, e)), this._simulateEvent(this.target, o, a.merge({
              touches: b,
              targetTouches: b,
              changedTouches: f,
              scale: C,
      ...
      tap: function(b, c, e, f, g) {
        ...
        for (c = this._calculateDefaultPoint(c), (!a.Lang.isNumber(e) || 1 > e) && (e = 1), a.Lang.isNumber(f) || (f = l.HOLD_TAP), a.Lang.isNumber(g) || (g = l.DELAY_TAP), k = {
          pageX: c[0],
          pageY: c[1],
          clientX: c[0],
          clientY: c[1]
        }, j = this._createTouchList([a.merge({identifier: 0}, k)]), p = function() {
          this._simulateEvent(this.target, m, a.merge({
            touches: j,
            targetTouches: j,
            changedTouches: j
          ...
          this._simulateEvent(this.target, o, a.merge({
            touches: i,
            targetTouches: i,
            changedTouches: j
          }, k));
      ...
      flick: function(c, d, e, f, g) {
        var h;
        d = this._calculateDefaultPoint(d), a.Lang.isString(e) ? (e = e.toLowerCase(), e !== x && e !== y && a.error(b + "(flick): Only x or y axis allowed")) : e = x, a.Lang.isNumber(f) || (f = l.DISTANCE_FLICK), a.Lang.isNumber(g) ? g > l.MAX_DURATION_FLICK && (g = l.MAX_DURATION_FLICK) : g = l.DURATION_FLICK, Math.abs(f) / g < l.MIN_VELOCITY_FLICK && (g = Math.abs(f) / l.MIN_VELOCITY_FLICK), h = {
          start: a.clone(d),
          end: [e === x ? d[0] + f : d[0], e === y ? d[1] + f : d[1]]
        }, this._move(c, h, g);
      },
      move: function(b, c, d) {
        var e;
        a.Lang.isObject(c) ? (c.point = a.Lang.isArray(c.point) ? this._calculateDefaultPoint(c.point) : this._calculateDefaultPoint([]), a.Lang.isNumber(c.xdist) || (c.xdist = l.DISTANCE_MOVE), a.Lang.isNumber(c.ydist) || (c.ydist = 0)) : c = {
          point: this._calculateDefaultPoint([]),
          xdist: l.DISTANCE_MOVE,
          ydist: 0
        }, a.Lang.isNumber(d) ? d > l.MAX_DURATION_MOVE && (d = l.MAX_DURATION_MOVE) : d = l.DURATION_MOVE, e = {
      ...
      _move: function(b, c, d) {
        var e,
            ...
            g = i,
            r = 0;
        for (a.Lang.isNumber(d) ? d > l.MAX_DURATION_MOVE && (d = l.MAX_DURATION_MOVE) : d = l.DURATION_MOVE, a.Lang.isObject(c) ? (a.Lang.isArray(c.start) || (c.start = [j, k]), a.Lang.isArray(c.end) || (c.end = [j + l.DISTANCE_MOVE, k])) : c = {
          start: [j, k],
          end: [j + l.DISTANCE_MOVE, k]
        }, a.AsyncQueue.defaults.timeout = g, e = new a.AsyncQueue, e.add({
          fn: function() {
            var b = {
              pageX: c.start[0],
              pageY: c.start[1],
              ...
              clientY: c.start[1]
                ...
                d = this._createTouchList([a.merge({identifier: r++}, b)]);
            this._simulateEvent(this.target, m, a.merge({
              touches: d,
              targetTouches: d,
              changedTouches: d
          ...
          timeout: 0,
          context: this
        }), h = Math.floor(d / g), p = (c.end[0] - c.start[0]) / h, q = (c.end[1] - c.start[1]) / h, s = function(b) {
          var d = c.start[0] + p * b,
              e = c.start[1] + q * b,
              f = {
                pageX: d,
              ...
              g = this._createTouchList([a.merge({identifier: r++}, f)]);
          this._simulateEvent(this.target, n, a.merge({
            touches: g,
            targetTouches: g,
            changedTouches: g
          ...
          fn: function() {
            var b = {
              ...
              clientY: c.end[1]
                ...
                e = this._createTouchList([a.merge({identifier: r}, b)]);
            this._simulateEvent(this.target, o, a.merge({
              touches: d,
              targetTouches: d,
              changedTouches: e
      ...
      _createTouchList: function(c) {
        ...
        return c && a.Lang.isArray(c) ? a.UA.android && a.UA.android >= 4 || a.UA.ios && a.UA.ios >= 2 ? (a.each(c, function(b) {
          ...
          a.identifier || (a.identifier = 0), a.clientX || (a.clientX = 0), a.clientY || (a.clientY = 0), a.pageX || (a.pageX = 0), a.pageY || (a.pageY = 0), a.screenX || (a.screenX = 0), a.screenY || (a.screenY = 0), e.push({
            target: f.target,
      ...
      _simulateEvent: function(b, c, e) {
        var g;
        f[c] ? d ? a.Event.simulate(b, c, e) : this._isSingleTouch(e.touches, e.targetTouches, e.changedTouches) ? (c = {
          touchstart: u,
          touchmove: t,
          touchend: s
        }[c], e.button = 0, e.relatedTarget = null, g = c === s ? e.changedTouches : e.touches, e = a.mix(e, {
          screenX: g.item(0).screenX,
          screenY: g.item(0).screenY,
          clientX: g.item(0).clientX,
          clientY: g.item(0).clientY
        }, !0), a.Event.simulate(b, c, e), c == s && a.Event.simulate(b, v, e)) : a.error("_simulateEvent(): Event '" + c + "' has multi touch objects that can't be simulated in your platform.") : a.Event.simulate(b, c, e);
      },
      ...
      if (d = d.toLowerCase(), !g && a.Lang.isFunction(f) && (g = f, f = {}), f = f || {}, e[d])
        switch (d) {
          case "tap":
        ...
        a.error(b + ": Not a supported gesture simulation: " + d);
    };
    ...
    r.ATTRS = {
      ...
      _initDescendants: function() {
        var i,
            k,
            l,
            b = this.get("descendants"),
            g = {},
            h = -1,
            j = this.get(c),
            m = 0;
        if (p.isUndefined(j) && (j = -1), b) {
          for (i = b.size(), m = 0; i > m; m++)
            k = b.item(m), -1 === h && !k.get(e) && (h = m), 0 > j && 0 === parseInt(k.getAttribute(f, 2), 10) && (j = m), k && k.set(f, -1), l = k.get(d), l || (l = a.guid(), k.set(d, l)), g[l] = m;
    ...
    var h,
        ...
        d = a.Lang,
        e = a.Node,
        f = a.ClassNameManager,
        g = f.getClassName,
        i = a.cached(function(a) {
        ...
        O = a.UA.webkit,
        P = {};
    c.NAME = "widget", L = c.UI_SRC = "ui", c.ATTRS = M, M[y] = {
      valueFn: "_guid",
      writeOnce: J
    }, M[A] = {
      value: K,
      ...
      value: K,
      readOnly: J
    }, M[m] = {value: K}, M[k] = {value: J}, M[p] = {value: H}, M[o] = {value: H}, M[C] = {
      value: {},
      setter: "_strSetter",
      getter: "_strGetter"
    }, M[z] = {
      value: K,
      writeOnce: J
    }, c.CSS_PREFIX = g(c.NAME.toLowerCase()), c.getClassName = function() {
      ...
      render: function(a) {
        return !this.get(B) && !this.get(A) && (this.publish(z, {
          queuable: K,
          fireOnce: J,
          defaultTargetOnly: J,
          defaultFn: this._defRenderFn
        }), this.fire(z, {parentNode: a ? e.one(a) : null})), this;
      },
      ...
      _renderBoxClassNames: function() {
        var b,
            ...
            a = this._getClasses(),
            c = this.get(q);
        for (c.addClass(h()), d = a.length - 3; d >= 0; d--)
          b = a[d], c.addClass(b.CSS_PREFIX || g(b.NAME.toLowerCase()));
        this.get(r).addClass(this.getClassName(j));
      },
      _removeLoadingClassNames: function() {
        var a = this.get(q),
            b = this.get(r),
            c = this.getClassName(F),
            d = h(F);
      ...
      _bindAttrUI: function(a) {
        var b,
            c = a.length;
        for (b = 0; c > b; b++)
          this.after(a[b] + E, this._setAttrUI);
      },
    ...
    requires: ["attribute", "base-base", "base-pluginhost", "classnamemanager", "event-focus", "node-base", "node-style"],
    skinnable: !0
  }), YUI.add("widget-htmlparser", function(a) {
    var c = a.Widget,
        d = a.Node,
        e = a.Lang,
        f = "srcNode",
        g = "contentBox";
    c.HTML_PARSER = {}, c._buildCfg = {aggregates: ["HTML_PARSER"]}, c.ATTRS[f] = {
      value: null,
      setter: d.one,
      getter: "_getSrcNode",
      writeOnce: !0
      ...
      _getHtmlParser: function() {
        ...
        for (d = b.length - 1; d >= 0; d--)
          e = b[d].HTML_PARSER, e && a.mix(c, e, !0);
        return c;
      }
    });
    ...
    var c = "boundingBox",
        d = "contentBox",
        e = "skin",
        f = a.ClassNameManager.getClassName;
    a.Widget.prototype.getSkinName = function(a) {
      var g,
          h,
          b = this.get(d) || this.get(c);
    ...
    var c = "boundingBox",
        ...
        f = a.Lang,
        g = ":",
        h = a.Widget._uievts = a.Widget._uievts || {};
    a.mix(d.prototype, {
    ...
    var d = a.Lang,
        ...
        f = "boundingBox";
    c.ATTRS = {
      defaultChildType: {setter: function(b) {
          var c = a.Attribute.INVALID_VALUE,
              e = d.isString(b) ? a[b] : b;
          return d.isFunction(e) && (c = e), c;
        }},
      activeDescendant: {readOnly: !0},
      multiple: {
        value: !1,
      ...
      _createChild: function(b) {
        var f,
            g,
            h,
            c = this.get("defaultChildType"),
            e = b.childType || b.type;
      ...
      _add: function(b, c) {
        ...
        }, this), e.length > 0 && (g = e)) : (f = a.instanceOf(b, a.Widget) ? b : this._createChild(b), f && this.fire("addChild", {
          child: f,
          index: c
        }) && (g = f)), g;
      },
      add: function() {
        var b = this._add.apply(this, arguments),
            c = b ? d.isArray(b) ? b : [b] : [];
      ...
      remove: function(a) {
        var c,
            b = this._items[a];
        return b && this.fire("removeChild", {
          child: b,
          index: a
        }) && (c = b), c;
      },
    ...
    c.ATTRS = {
      ...
      ancestor: function(a) {
        var c,
            b = this.get("root");
        if (this.get("depth") > a)
          for (c = this.get("parent"); c != b && c.get("depth") > a; )
            c = c.get("parent");
        return c;
      },
      _uiSetChildSelected: function(a) {
        var b = this.get("boundingBox"),
            c = this.getClassName("selected");
    ...
    j.NAME = "tabviewBase", j._classNames = {
      tabview: c(d),
      tabviewPanel: c(d, f),
      tabviewList: c(d, "list"),
      tab: c(e),
      tabLabel: c(e, "label"),
      tabPanel: c(e, f),
      selectedTab: c(e, g),
      selectedPanel: c(e, f, g)
    }, j._queries = {
      tabview: i + j._classNames.tabview,
      tabviewList: "> ul",
      tab: "> ul > li",
      tabLabel: "> ul > li > a",
      tabviewPanel: "> div",
      tabPanel: "> div > div",
      selectedTab: "> ul > " + i + j._classNames.selectedTab,
      selectedPanel: "> div " + i + j._classNames.selectedPanel
    }, a.mix(j.prototype, {
      init: function(b) {
      ...
      _select: function(b) {
        var c = a.TabviewBase._classNames,
            d = a.TabviewBase._queries,
            e = this._node,
            f = e.one(d.selectedTab),
            g = e.one(d.selectedPanel),
            h = e.all(d.tab).item(b),
            i = e.all(d.tabPanel).item(b);
        f && f.removeClass(c.selectedTab), g && g.removeClass(c.selectedPanel), h && h.addClass(c.selectedTab), i && i.addClass(c.selectedPanel);
      },
      initState: function() {
        var b = a.TabviewBase._queries,
            c = this._node,
            d = c.one(b.selectedTab),
            e = d ? c.all(b.tab).indexOf(d) : 0;
        this._select(e);
      },
    ...
    var c = ".",
        d = a.Base.create("tabView", a.Widget, [a.WidgetParent], {
          ...
          _afterChildRemoved: function(a) {
            var b = a.index,
                c = this.get("selection");
            c || (c = this.item(b - 1) || this.item(0), c && c.set("selected", 1)), this.get("contentBox").focusManager.refresh();
          },
          _initAria: function() {
            var b = this.get("contentBox"),
                c = b.one(a.TabviewBase._queries.tabviewList);
            c && c.setAttrs({role: "tablist"});
          },
          bindUI: function() {
            this.get("contentBox").plug(a.Plugin.NodeFocusManager, {
              descendants: c + a.TabviewBase._classNames.tabLabel,
              keys: {
                next: "down:39",
                previous: "down:37"
              },
          ...
          _renderTabs: function(b) {
            var d = a.TabviewBase._classNames,
                e = a.TabviewBase._queries,
                f = b.all(e.tab),
                g = this.get("panelNode"),
                h = g ? this.get("panelNode").get("children") : null,
                i = this;
    ...
    d.prototype.LIST_TEMPLATE = d.LIST_TEMPLATE, d.prototype.PANEL_TEMPLATE = d.PANEL_TEMPLATE, a.TabView = d, a.Tab = a.Base.create("tab", a.Widget, [a.WidgetChild], {
      BOUNDING_TEMPLATE: "<li></li>",
      CONTENT_TEMPLATE: "<a></a>",
      PANEL_TEMPLATE: "<div></div>",
      _uiSetSelectedPanel: function(b) {
      ...
      _initAria: function() {
        var b = this.get("contentBox"),
            c = b.get("id"),
            d = this.get("panelNode");
        c || (c = a.guid(), b.set("id", c)), b.set("role", "tab"), b.get("parentNode").set("role", "presentation"), d.setAttrs({
          role: "tabpanel",
          "aria-labelledby": c
        });
      },
      ...
      _add: function() {
        var a = this.get("parent").get("contentBox"),
            b = a.get("listNode"),
            c = a.get("panelNode");
      ...
      _defPanelNodeValueFn: function() {
        var f,
            b = a.TabviewBase._classNames,
            c = this.get("contentBox").get("href") || "",
            d = this.get("parent"),
            e = c.indexOf("#");
